...
/**
 * Servlet implementation class QiFuUpdate1Servlet
 */
@WebServlet("/QiFuUpdate1Servlet")
public class QiFuUpdate1Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QiFuUpdate1Servlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/page/qifuupdate.jsp").forward(request, response);
	}
