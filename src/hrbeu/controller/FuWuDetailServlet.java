...
/**
 * Servlet implementation class FuWuDetailServlet
 */
@WebServlet("/FuWuDetailServlet")
public class FuWuDetailServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FuWuDetailServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/page/fuwudetail.jsp").forward(request, response);
	}
