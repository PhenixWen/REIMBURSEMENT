...
/**
 * Servlet implementation class FenDuanDetailServlet
 */
@WebServlet("/FenDuanDetailServlet")
public class FenDuanDetailServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FenDuanDetailServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/page/fenduandetail.jsp").forward(request, response);
	}
