...
/**
 * Servlet implementation class AjaxCheckServId
 */
@WebServlet("/AjaxCheckServId")
public class AjaxCheckServId extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxCheckServId() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for(int i = 0; i < l; ++i)
		{
			if(servId.charAt(i) < '0' || servId.charAt(i) > '9')
			{
				p = true;
				break;
			}
