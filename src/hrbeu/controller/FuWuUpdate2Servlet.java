...
/**
 * Servlet implementation class FuWuUpdate2Servlet
 */
@WebServlet("/FuWuUpdate2Servlet")
public class FuWuUpdate2Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FuWuUpdate2Servlet() {
        super();
