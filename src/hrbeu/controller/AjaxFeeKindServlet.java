...
/**
 * Servlet implementation class AjaxFeeKindServlet
 */
@WebServlet("/AjaxFeeKindServlet")
public class AjaxFeeKindServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxFeeKindServlet() {
        super();
