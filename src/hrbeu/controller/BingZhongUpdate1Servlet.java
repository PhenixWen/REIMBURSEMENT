...
/**
 * Servlet implementation class BingZhongUpdate1Servlet
 */
@WebServlet("/BingZhongUpdate1Servlet")
public class BingZhongUpdate1Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BingZhongUpdate1Servlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/page/bingzhongupdate.jsp").forward(request, response);
	}
