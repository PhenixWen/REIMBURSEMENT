...
function returnFloat(value){
	 ...
	 return value;
    	...
    	function golis(){
    		...
    		var url = "/REIMBURSEMENT/msg_fwss?personId=";
    		if(personId !== null && personId !== undefined && personId !== '') url = url+personId;
    		else url = url+personId0;
    		url = url + "&solveid=";
		...
		function servName() {
    		$.ajax({
				url:"/REIMBURSEMENT/add_fwss_ajax",
				type:"GET",
				dataType:"json",
				success:function(data){
					var curservId = $("#curservId").val();
					var str="";
					$(data).each(function(i,fw){
						if(fw.servId != curservId){
							str= str + "<option value=" + fw.servId + ">" + fw.servName+ "</option>";
						}
						else{
							str= str + "<option value=" + fw.servId + " selected='selected'>" + fw.servName + "</option>";
						}
					});
					$("#servName").html(str);
				},
...
<body onload = "fun1();fun2();servName();price();num();" data-type="generalComponents">
...
<div class="tpl-page-container tpl-page-header-fixed">
    ...
    <div class="tpl-content-wrapper">
        ...
        <ol class="am-breadcrumb">
            ...
            <li><a href="javascript:void(0);" onclick ="golis()">服务设施明细信息</a></li>
            <li class="am-active">修改服务设施明细</li>
        </ol>
        ...
        <div class="tpl-portlet-components">
            <div class="portlet-title">
                <div class="caption font-green bold">
                    <span class="am-icon-code"></span>修改服务设施明细
                </div>
            ...
            <div class="tpl-block ">
                ...
                <div class="am-g tpl-amazeui-form">
                    ...
                    <div class="am-text-center" style="color: red">带黄色圆圈项为必填项</div>
                        <form style="padding-left:100px;" action="/REIMBURSEMENT/edi_fwss2?ide=${requestScope.lis.ide}" method="post" class="am-form am-form-horizontal">
                            <div class="am-form-group">
                                <label for="user-name" class="am-u-sm-3 am-form-label">住院号</label>
                                <div class="am-u-sm-9">
                                    <input  type="text" id="solveId" name="solveId" readonly="readonly" value="${requestScope.lis.solveId}">
                                    <input style="display:none;" type="text" id="personId" name="personId">
                              	</div>
                            </div>
                            <div class="am-form-group">
                                <label for="user-name" class="am-u-sm-3 am-form-label">服务名称</label>
                                <input type="hidden" id="curservId" value="${requestScope.lis.servId}">
                                <div class="am-u-sm-9">
<select id="servName" data-am-selected="{searchBox: 1, maxHeight: 100}"style="display: none;" name="servId"></select>
                                </div>
                            </div>
                                ...
                                <div class="am-u-sm-9">
                                    <input  type="text" name="price" id="price" placeholder="输入单价" value="${requestScope.lis.price}">
                                </div>
                            ...
                            <div class="am-form-group am-form-warning am-form-icon am-form-feedback" id = "divNum">
                                ...
                                <div class="am-u-sm-9">
                                    <input  type="text" name="num" id="num" placeholder="输入数量" value="${requestScope.lis.num}">
                                </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" name="sum" id="sum" placeholder="0" readonly="readonly" value="${requestScope.lis.sum}">
                                </div>
                            </div>
                            <div class="am-form-group">
