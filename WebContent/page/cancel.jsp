...
<html><head>
    ...
    {
    	var r=confirm("确定撤销此次报销记录？")
    	if (r==true)
      	{
    		window.location.href='/REIMBURSEMENT/cancel2?solveId='+solveId+'&personId='+personId;
	    }
    }
    </script>
</head>
...
<div class="tpl-page-container tpl-page-header-fixed">
    ...
    <div class="tpl-content-wrapper">
        ...
        <div class="tpl-portlet-components">
            ...
            <div class="tpl-block">
                <div class="am-g">
                    <form action="/REIMBURSEMENT/cancel1" method="post" class="am-form am-form-inline">
                        ...
                        <div class="am-form-group" >
                            <input type="text"  id="doc-ipt-pwd-1" placeholder="姓名">
                        </div>
                    ...
                    <div class="am-u-sm-12">
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                <thead>
                                <tr>
                                    <th class="table-title">人员编号</th>
                                    <th class="table-title">人员姓名</th>
                                    <th class="table-title">医疗机构</th>
                                    <th class="table-title">病种名称</th>
                                    <th class="table-title">费用总额</th>
                                    <th class="table-title">报销金额</th>
                                ...
                                <tbody>
                                <c:forEach items="${requestScope.solves}" var="s">
							    <tr>
							        <td>${s.personId}</td>
							        <td>${s.personName}</td>
							        <td>${s.compName}</td>
							        ...
							        <td>
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <button type = "button" class="am-btn am-btn-default am-btn-xs am-hide-sm-only am-text-danger" onclick="del(${s.solveId}, ${s.personId})"><span class="am-icon-trash-o"></span>取消报销</button>
                                            </div>
                                        </div>
                                    </td>
							    </tr>
                                    ...
                                    <ul class="am-pagination tpl-pagination">
	                                   <c:forEach begin="1" step="1" end="${requestScope.pages}" var="i">
										    ...
										    <c:if test="${i eq requestScope.pagenow }">
										    	<li class="am-active">
										    	<a href="/REIMBURSEMENT/cancel1?page=${i }">${i }</a>
										    	</li>
										    </c:if>
