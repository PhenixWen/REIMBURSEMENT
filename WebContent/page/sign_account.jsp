  ...
  <div class="am-g myapp-login">
	<div class="myapp-login-logo-block  tpl-login-max">
		...
		<div class="login-font">
			<i>用户注册</i> <!-- or <span> Sign Up</span> -->
		</div>
		<div class="am-u-sm-10 login-am-center">
			<form class="am-form" method="post" action="/REIMBURSEMENT/RegisterServlet">
				<fieldset>
					<div class="am-form-group">
						<input type="text" class="" name="name" id="doc-ipt-email-1" placeholder="输入用户名">
					</div>
					<div class="am-form-group">
						<input type="password" name="psw1" class="" id="doc-ipt-pwd-1" placeholder="输入密码">
					</div>
					<div>
						<input type="password" name="psw2" class="" id="doc-ipt-pwd-1" placeholder="再次输入密码">
					</div>
					<div style="color:red"><strong>该用户名已被注册</strong></div>
