            ...
            <div class="tpl-block ">
                ...
                <div class="am-g tpl-amazeui-form">
                    ...
                    <div class="am-text-center" style="color: red">带黄色圈项为必填项</div>
                        ...
                        action="/REIMBURSEMENT/InsInsertServlet" method="post">
                            ...
                            <div class="am-form-group am-form-warning am-form-icon am-form-feedback">
                                ...
                                <div class="am-u-sm-9">
                                    <input id="name" placeholder="输入单位名称" type="text" name="name">
                                </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input id="user-weibo" placeholder="输入公司地址" type="text" name="address">
                                </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input id="user-weibo" placeholder="输入公司邮编" type="text" name="postcode">
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input id="user-weibo" placeholder="输入公司电话" type="text" name="tel">
                                </div>
