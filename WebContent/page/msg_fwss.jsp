...
<div class="tpl-page-container tpl-page-header-fixed">
    ...
    <div class="tpl-content-wrapper">
        ...
        <ol class="am-breadcrumb">
            ...
            <li class="am-active">服务设施明细信息</li>
        </ol>

        <div class="tpl-portlet-components">
            <div class="portlet-title">
                <div class="caption font-green bold">
                    <span class="am-icon-code"></span> 服务设施明细信息
                </div>
            </div>
            <button id="add" type="button" class="am-btn am-btn-primary am-btn-success" onclick="window.open('/REIMBURSEMENT/page/add_fwss.jsp?solveId=${requestScope.solveId}','_self')" >
                    ...
                    <div class="am-u-sm-12">
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                <thead>
                                <tr>
                                	<th class="table-title">服务设施编号</th>
                                    <th class="table-title">服务设施名称</th>
                                    ...
                                    <td>
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <button id="edit" type = "button"class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="window.open('/REIMBURSEMENT/edi_fwss1?solveId=${solveId}&ide=${l.ide}','_self')" ><span class="am-icon-pencil-square-o"></span> 编辑</button>
                                                <button id="delete" type = "button"class="am-btn am-btn-default am-btn-xs am-text-danger" onclick="window.open('/REIMBURSEMENT/del_fwss?solveId=${solveId}&ide=${l.ide}','_self')" ><span class="am-icon-trash-o"></span>删除</button>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <div class="am-fr">
                                    <ul class="am-pagination tpl-pagination">
									    ...
									    <c:if test="${i eq requestScope.pagenow}">
									    	<li class="am-active">
									    	<a href="/REIMBURSEMENT/msg_fwss?page=${i}&personId=${requestScope.personId}&solveId=${requestScope.solveId}">${i}</a>
									    	</li>
									    </c:if>
