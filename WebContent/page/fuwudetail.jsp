...
<div class="tpl-page-container tpl-page-header-fixed">
    ...
    <div class="tpl-content-wrapper">
        ...
        <ol class="am-breadcrumb">
            ...
            <li class="am-active">服务设施项目信息详情</li>
        </ol>
        ...
        <div class="tpl-portlet-components">
            ...
            <table style="  text-align:center;  table-layout:fixed; background-color:white" class="am-table  am-table-striped am-table-hover am-table-compact am-table-bordered am-table-radius am-table-striped">
                <tbody>
                <tr>
                    <td style="color: black">服务设施编号</td>
                    <td style="color: black">${requestScope.service.servId }</td>
                </tr>
                <tr>
                    <td style="color: black">服务设施名称</td>
                    <td style="color: black">${requestScope.service.servName }</td>
                </tr>
                <tr>
                    <td style="color: black">收费类别</td>
                    <td style="color: black">${requestScope.service.feeKind }</td>
                </tr>
                <tr>
                    <td style="color: black">限制使用范围</td>
                    <td style="color: black">${requestScope.service.rge }</td>
                </tr>
                <tr>
                    <td style="color: black">备注</td>
                    <td style="color: black">${requestScope.service.remarks }</td>
                </tr>
                </tbody>
            </table>
