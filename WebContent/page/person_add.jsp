...
<script>
	/* $(function() {
		$("#InsID").blur(function() {
				var value = $("#InsID").val();
				$.ajax({
					url : "/REIMBURSEMENT/AjaxPersonInsertCheckIns?InsID=" + value,
					type : "GET",
					dataType : "text",
					success : function(data) {
						if (data != 'no') {
							...
							$("#spanIns").html("该单位编号不存在");

							
						} else {
							alert("BUG: not yes nor no");
						}
					},
					error : function() {
						alert("error");
		...
		$("#compID")
				.blur(
						function() {
							...
							$
									.ajax({
										url : "/REIMBURSEMENT/AjaxCheckCompID?compID="
												+ value,
										type : "GET",
										dataType : "text",
										success : function(data) {
 ...
 */
 ...
 $(function() {
			...
			success : function(data) {
				...
				$(data).each(
						function(i, p) {
							/* alert(dept.deptName);
							alert(dept.deptNo); */
							str = str + "<option value=" + p.id + ">"
									+ p.patientKind + "</option>";
						});
				$("#pat").html(str);
			},
			error : function() {
	...
	function check() {
		...
		if ($("#cID").val() == '' || $("#name").val() == '' || $("#birthday").val() == '') {
			alert("存在必填项为空");
			return false;
		}
		else{
			...
			<div class="tpl-portlet-components">
				<div class="portlet-title">
					<div class="caption font-green bold">
						<span class="am-icon-code"></span>个人信息添加
					</div>
					...
					<div class="am-g tpl-amazeui-form">
						<div class="am-u-sm-12 am-u-md-9">
							...
							<form class="am-form am-form-horizontal"
								...
								action="/REIMBURSEMENT/PersonInsertServlet" method="post">
								...
								<div class="am-form-group">
									...
									<div
										...
										<div class="am-u-sm-9">
											<input class="" placeholder="输入证件编号" name="cID" type="text"
												id="cID">
										</div>
									...
									<div
										...
										<div class="am-u-sm-9">
											<input id="name" class="" placeholder="输入姓名" name="name"
												type="text">
										</div>
										<span class="am-icon-circle-o"></span>
									</div>
									...
									<div class="am-form-group am-form-warning am-form-icon am-form-feedback">
										...
										<div class="am-u-sm-9">
											<input class="" data-am-datepicker=""
