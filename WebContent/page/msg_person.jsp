    ...
    <div class="tpl-content-wrapper">
        ...
        <div class="tpl-portlet-components">
            ...
            <table  style="  text-align:center;  table-layout:fixed; background-color:white" class="am-table  am-table-striped am-table-hover am-table-compact am-table-bordered am-table-radius am-table-striped">
                <tbody >
                <tr>
                    <td style="color: black">人员ID</td>
                    <td style="color: black">${requestScope.a.person.personID}</td>
                </tr>
                <tr>
                    <td style="color: black">姓名</td>
                    <td style="color: black">${requestScope.a.person.personName}</td>
                </tr>
                <tr>
                    <td style="color: black">身份证号</td>
                    <td style="color: black">${requestScope.a.person.certifiID}</td>
                </tr>
                <tr>
                    <td style="color: black">社保卡号</td>
                    <td style="color: black">${requestScope.a.person.socialID}</td>
                </tr>
                <tr>
                    <td style="color: black">性别</td>
                    <td style="color: black">${requestScope.a.person.personSex}</td>
                </tr>
                <tr>
                    <td style="color: black">出生日期</td>
                    <td style="color: black">${requestScope.a.person.birthday}</td>
                </tr>
                <tr>
                    <td style="color: black">医疗人员类别</td>
                    <td style="color: black">${requestScope.patientKind}</td>
                </tr>
                <tr>
                    <td style="color: black">单位编号</td>
                    <td style="color: black">${requestScope.a.person.insID}</td>
                </tr>
                <tr>
                    <td style="color: black">单位名称</td>
                    <td style="color: black">${requestScope.insName}</td>
                </tr>
                <tr>
                    <td style="color: black">本年住院次数</td>
                    <td style="color: black">${requestScope.a.ztimes}</td>
                </tr>
                <tr>
                   	<td style="color: black">上次出院时间</td>
                    <c:if test="${requestScope.last_date ne '0'}">
						<td style="color: black">${requestScope.last_date}</td>                        	
					</c:if>
					<c:if test="${requestScope.last_date eq '0'}">
						<td style="color: black">暂无记录</td>                        	
					</c:if>
                </tr>
                <tr>
                    <td style="color: black">上次出院诊断</td>
                    <c:if test="${requestScope.last_dise ne '0'}">
						<td style="color: black">${requestScope.last_dise}</td>                        	
					</c:if>
					<c:if test="${requestScope.last_dise eq '0'}">
						<td style="color: black">暂无记录</td>                        	
					</c:if>                    
                </tr>
                <tr>
                    <td style="color: black">上次出院原因</td>
                    <c:if test="${requestScope.last_reason ne '0'}">
						<td style="color: black">${requestScope.last_reason}</td>                        	
					</c:if>
					<c:if test="${requestScope.last_reason eq '0'}">
						<td style="color: black">暂无记录</td>                        	
					</c:if>                    
                </tr>
                <tr>
                    <td style="color: black">本年医疗费用累计</td>
                    <td style="color: black">${requestScope.a.money}</td>
                </tr>
                <tr>
                    <td style="color: black">本年中心报销累计</td>
                    <td style="color: black">${requestScope.a.baoxiao}</td>
                </tr>
                <tr>
                    <td style="color: black">本年个人自费累计</td>
                    <td style="color: black">${requestScope.a.cost}</td>
                </tr>
