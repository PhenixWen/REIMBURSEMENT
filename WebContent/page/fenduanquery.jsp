...
<div class="tpl-page-container tpl-page-header-fixed">
    ...
    <div class="tpl-content-wrapper">
        ...
        <ol class="am-breadcrumb">
            ...
            <li><a href="/REIMBURSEMENT/page/fenduanquery.jsp">个人自费比例</a></li>
        </ol>
        ...
        <div class="tpl-portlet-components">
            <div class="portlet-title">
                <div class="caption font-green bold">
                    <span class="am-icon-code"></span>个人自费比例
                </div>
            ...
            <div class="tpl-block">
                <div class="am-g">
                    <form class="am-form am-form-inline" method = "post" action = "/REIMBURSEMENT/FenDuanQueryServlet">
                        <label class="am-form-label" for="doc-ipt-pwd-1">数据编号：</label>
                        <div class="am-form-group">

                            <input id="doc-ipt-pwd-1" placeholder="编号" class="" type="text" name = "ide">
                        </div>  <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                        <label for="user-phone" class="am-form-label">医疗类别：</label>
                        <div class="am-form-group">
...
<!--                                     <option value="二类">二类</option> -->
                        ...
                        <label for="user-phone" class="am-form-label">医疗人员类别：</label>
                        <div class="am-form-group">
...
<!--                                     <option value="公务员">公务员</option> -->
                        ...
                        <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                        <label for="user-phone" class="am-form-label">医院等级：</label>
                        <div class="am-form-group">
...
<!--                                     <option value="社区医院">社区医院</option> -->
                        ...
                        <button type="button" class="am-btn am-btn-primary am-btn-success" onclick="window.open('/REIMBURSEMENT/page/fenduanadd.jsp')" >
                            <span class="am-icon-plus"></span><span>新增</span>
                        </button>
                        <!--<a class="/REIMBURSEMENT/page/am-btn am-btn-primary am-btn-success am-btn-danger" href="fenduanadd.jsp" target="_blank"><span class="am-icon-plus"></span>添加</a>-->
                        ...
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                ...
                                <tr>
                                    ...
                                    <th class="table-type">医疗类别</th>
                                    <th class="table-type">医疗人员类别</th>
                                    <th class="table-type">医院等级</th>
                                    <th class="table-type">上限金额</th>
                                    <th class="table-type">下限金额</th>
                                    <th class="table-set">报销比例</th>
                                </tr>
                                </thead>
                                <tbody>
<!--                                 <tr> -->
<%--                                      <c:forEach items = "${requestScope.fenduanlist }" var = "f"> --%>
<!--                                      	<tr> -->
<%--                                      		<td>${f.ide }</td> --%>
<%-- 	                                    	<td>${f.cureKind }</td> --%>
<%-- 	                                    	<td>${f.patientKind }</td> --%>
...
<%-- 		                                                <button type = "button" class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="window.location.href='/REIMBURSEMENT/FenDuanUpdate1Servlet?ide=${f.ide }'"><span --%>
<!-- 		                                                        class="am-icon-pencil-square-o"></span>编辑 -->
<!-- 		                                                </button> -->
<%-- 		                                                <button type = "button" class="am-btn am-btn-default am-btn-xs am-hide-sm-only" onclick="window.location.href='/REIMBURSEMENT/FenDuanDetailServlet?ide=${f.ide }'"><span --%>
<!-- 		                                                        class="am-icon-copy"></span>详情 -->
<!-- 		                                                </button> -->
<%-- 		                                                <button type = "button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="window.location.href='/REIMBURSEMENT/FenDuanDeleteServlet?ide=${f.ide }'"> --%>
                                ...
                                <div class="am-fr">
                                    ...
                                    <c:forEach begin="1" step="1" end="${requestScope.pages}" var="i">
									    ...
									    <c:if test="${i eq requestScope.curpage }">
									    	<li class="am-active">
									    	<a href="/REIMBURSEMENT/FenDuanQueryServlet?page=${i }&ide=${requestScope.ide}&cureKind=${requestScope.cureKind}&hosRank=${requestScope.hosRank}&patientKind=${requestScope.patientKind}&mark=1">${i }</a>
									    	</li>
									    </c:if>
