...
<div class="tpl-page-container tpl-page-header-fixed">
    ...
    <div class="tpl-content-wrapper">
        ...
        <ol class="am-breadcrumb">
            ...
            <li><a href="/REIMBURSEMENT/page/fengdingquery.jsp">封顶线</a></li>
        </ol>
        ...
        <div class="tpl-portlet-components">
            <div class="portlet-title">
                <div class="caption font-green bold">
                    <span class="am-icon-code"></span>封顶线
            ...
            <div class="tpl-block">
                <div class="am-g">
                    <form class="am-form am-form-inline" method = "post" action = "/REIMBURSEMENT/FengDingQueryServlet">
                        <label for="user-phone" class="am-form-label">医疗人员类别：</label>
                        <div class="am-form-group">
                                <select data-am-selected="{searchBox: 1, maxHeight: 100}" name = "patientKind" id = "patientKind">
<!--                                     <option value=""></option> -->
...
<!--                                     <option value="公务员">公务员</option> -->
                        ...
                        <button type="button" class="am-btn am-btn-primary am-btn-success" onclick="window.open('/REIMBURSEMENT/page/fengdingadd.jsp')" >
                        ...
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                ...
                                <tr>
                                    ...
                                    <th class="table-type">封顶线</th>
                                </tr>
                                </thead>
                                <tbody>
<!--                                 <tr> -->
<%--                                      <c:forEach items = "${requestScope.fengdinglist }" var = "f"> --%>
<!--                                      	<tr> -->
<%--                                      		<td>${f.ide }</td> --%>
<%--                                      		<td>${f.patientKind }</td> --%>
<%-- 	                                    	<td>${f.ceiling }</td> --%>
...
<%-- 		                                                <button type = "button" class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="window.location.href='/REIMBURSEMENT/FengDingUpdate1Servlet?ide=${f.ide }'"><span --%>
<!-- 		                                                        class="am-icon-pencil-square-o"></span>编辑 -->
<!-- 		                                                </button> -->
<%-- 		                                                <button type = "button" class="am-btn am-btn-default am-btn-xs am-hide-sm-only" onclick="window.location.href='/REIMBURSEMENT/FengDingDetailServlet?ide=${f.ide }'"><span --%>
<!-- 		                                                        class="am-icon-copy"></span>详情 -->
<!-- 		                                                </button> -->
<%-- 		                                                <button type = "button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="window.location.href='/REIMBURSEMENT/FengDingDeleteServlet?ide=${f.ide }'"> --%>
                                ...
                                <div class="am-fr">
                                    ...
                                    <c:forEach begin="1" step="1" end="${requestScope.pages}" var="i">
									    ...
									    <c:if test="${i eq requestScope.curpage }">
									    	<li class="am-active">
									    	<a href="/REIMBURSEMENT/FengDingQueryServlet?page=${i }&patientKind=${requestScope.patientKind}&mark=1">${i }</a>
									    	</li>
									    </c:if>
