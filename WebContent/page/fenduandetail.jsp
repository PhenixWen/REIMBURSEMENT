        ...
        <div class="tpl-portlet-components">
            <div class="portlet-title">
                <div class="caption font-green bold">
                    <span class="am-icon-code"></span>个人分段自费比例信息</div>
            ...
            <table style="  text-align:center;  table-layout:fixed; background-color:white" class="am-table  am-table-striped am-table-hover am-table-compact am-table-bordered am-table-radius am-table-striped">
                <tbody>
                <tr>
                    <td style="color: black">数据编号</td>
                    <td style="color: black">${requestScope.seg.ide }</td>
                </tr>
                <tr>
                    <td style="color: black">医疗类型</td>
                    <td style="color: black">${requestScope.seg.cureKind }</td>
                </tr>
                <tr>
                    <td style="color: black">医疗人员类型</td>
                    <td style="color: black">${requestScope.seg.patientKind }</td>
                </tr>
                <tr>
                    <td style="color: black">医院等机构</td>
                    <td style="color: black">${requestScope.seg.hosRank }</td>
                </tr>
                <tr>
                    <td style="color: black">上限金额</td>
                    <td style="color: black">${requestScope.seg.ceiling }</td>
                </tr>
                <tr>
                    <td style="color: black">下限金额</td>
                    <td style="color: black">${requestScope.seg.floor }</td>
                </tr>
                <tr>
                    <td style="color: black">报销比例</td>
                    <td style="color: black">${requestScope.seg.ratio }</td>
                </tr>
                </tbody>
            </table>
