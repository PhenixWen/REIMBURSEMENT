...
<div class="tpl-page-container tpl-page-header-fixed">
    ...
    <div class="tpl-content-wrapper">
        ...
        <ol class="am-breadcrumb">
            ...
            <li><a href="/REIMBURSEMENT/page/basical_institutions.jsp">单位基本信息</a></li>
            <li class="am-active">单位信息添加</li>
        </ol>
         ...
         <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span>单位信息添加</div>
            ...
            <div class="tpl-block ">
                ...
                <div class="am-g tpl-amazeui-form">
                    ...
                    <div class="am-u-sm-12 am-u-md-9">
                        ...
                        action="/REIMBURSEMENT/InsUpdateServlet2" method="post">
                        
				    <div class="am-form-group">
					    <label for="user-weibo" class="am-u-sm-3 am-form-label">单位编号</label>
					    <div class="am-u-sm-9">
					    <input id="user-weibo" placeholder="输入单位编号"
					    	value="${requestScope.p.insID }" type="text" readonly="readonly" name="insID">
					    </div>
				    </div>
                            <div class="am-form-group am-form-warning am-form-icon am-form-feedback">
                                <label for="user-name" class="am-u-sm-3 am-form-label">单位名称</label>
                                <div class="am-u-sm-9">
                                    <input id="user-name" placeholder="输入单位名称" type="text" name="name" value="${requestScope.p.insName }">
                                </div>
                                <span id="spanId" class="am-icon-circle-o"></span>
                            </div>
                            <div class="am-form-group">
                                <label for="user-phone" class="am-u-sm-3 am-form-label">单位类别</label>
                                <div class="am-u-sm-9">
                                    <select data-am-selected="{searchBox: 1, maxHeight: 100}" style="display: none;" name="type">
                                        <!-- <option value="国企">国企</option>
                                        <option value="私企">私企</option>
                                        <option value="外企">外企</option>
                                        <option value="合资">合资</option> -->
                                        
                                        <c:if test="${requestScope.p.insType == '私企' }">
								    		<option value="私企" selected="selected">私企</option>
								    	</c:if>
								        <c:if test="${requestScope.p.insType != '私企'}">
								    		<option value="私企">私企</option>
								    	</c:if>
								    	
								    	<c:if test="${requestScope.p.insType == '国企' }">
								    	...
								    	<c:if test="${requestScope.p.insType == '外企' }">
								    		<option value="外企" selected="selected">外企</option>
								    	</c:if>
								        <c:if test="${requestScope.p.insType != '外企'}">
								    		<option value="外企">外企</option>
								    	</c:if>
								    	...
								    	<c:if test="${requestScope.p.insType == '合资' }">
								    		<option value="合资" selected="selected">合资</option>
								    	</c:if>
								        <c:if test="${requestScope.p.insType != '合资'}">
								    		<option value="合资">合资</option>
								    	</c:if>
                            ...
                            <div class="am-form-group">
                                <label for="user-weibo" class="am-u-sm-3 am-form-label">公司地址</label>
                                <div class="am-u-sm-9">
                                    <input id="user-weibo" placeholder="输入公司地址"
                                   value="${requestScope.p.insAdd }" type="text" name="address">
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                <label for="user-weibo" class="am-u-sm-3 am-form-label">公司邮编</label>
                                <div class="am-u-sm-9">
                                    <input id="user-weibo" value="${requestScope.p.insPost }" placeholder="输入公司邮编" type="text" name="postcode">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label for="user-weibo" class="am-u-sm-3 am-form-label">公司电话</label>
                                <div class="am-u-sm-9">
                                    <input id="user-weibo" value="${requestScope.p.insTel }" placeholder="输入公司电话" type="text" name="tel">
                                </div>
                            </div>
