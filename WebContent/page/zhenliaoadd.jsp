		...
		$("#projId")
				.blur(
						function() {
							...
							$
									.ajax({
										url : "/REIMBURSEMENT/AjaxCheckProjId?projId="
												+ value,
										type : "GET",
										dataType : "text",
										success : function(data) {
...
<div class="tpl-page-container tpl-page-header-fixed">
    ...
    <div class="tpl-content-wrapper">
        ...
        <ol class="am-breadcrumb">
            ...
            <li class="am-active">诊疗项目信息添加</li>
        </ol>
        ...
        <div class="tpl-portlet-components">
            <div class="portlet-title">
                <div class="caption font-green bold">
                    <span class="am-icon-code"></span>诊疗项目信息添加
                </div>
            ...
            <div class="tpl-block ">
                ...
                <div class="am-g tpl-amazeui-form">
                    ...
                    <div class="am-u-sm-12 am-u-md-9">
						...
						<br>
                        <form class="am-form am-form-horizontal" action = "/REIMBURSEMENT/ZhenLiaoAddServlet" method = "post" onsubmit="return check()">
                            <div class="am-form-group am-form-warning am-form-icon am-form-feedback" id = "divComp">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" id="projId" placeholder="输入项目编号" name = "projId">
                            ...
                            <div class="am-form-group am-form-warning am-form-icon am-form-feedback" id = "divComp2">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" id="projName" placeholder="输入项目名称" name = "projName">
...
<!--                                         <option value="丙">丙</option> -->
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" id="user-weibo" placeholder="输入单位名称" name = "company">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label for="user-weibo" class="am-u-sm-3 am-form-label">生产厂家</label>
                                <div class="am-u-sm-9">
                                    <input type="text" id="user-weibo" placeholder="输入生产厂家" name = "manufacturer">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label for="user-weibo" class="am-u-sm-3 am-form-label">限定使用范围</label>
                                <div class="am-u-sm-9">
                                    <input type="text" id="user-weibo" placeholder="输入使用范围" name = "rge">
                                </div>
                            </div>
                            <div class="am-form-group">
                            ...
                            <div class="am-form-group">
                                <div class="am-u-sm-9 am-u-sm-push-3">
                                    <button type="sumbit" class="am-btn am-btn-primary">添加</button>
                                </div>
                            </div>
                        </form>
                    </div>
