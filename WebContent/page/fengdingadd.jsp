...
// 					alert(str);
		...
		function checkPatientKind()
		{
			var p;
			 $.ajax({
				url:"/REIMBURSEMENT/AjaxCheckCeilingServlet",
				type:"POST",
				async:false,
  				data:{"patientKind":$("#patientKind").val()},
				dataType:"text",
				success:function(data){
					if(data == 'yes')
						p = true;
		...
		function check() {
			if ($("#divComp").hasClass("am-form-success")) {
				if(checkPatientKind())
				{
					return true;
				}
...
<div class="tpl-page-container tpl-page-header-fixed">
    ...
    <div class="tpl-content-wrapper">
        ...
        <div class="tpl-portlet-components" style = "height : 450px">
            <div class="portlet-title">
                <div class="caption font-green bold">
                    <span class="am-icon-code"></span>封顶线添加
            ...
            <div class="tpl-block ">
                ...
                <div class="am-g tpl-amazeui-form">
                    ...
                    <div class="am-text-center" style="color: red">带黄色圆圈项为必填项</div>
							<br>
                        <form class="am-form am-form-horizontal" action = "/REIMBURSEMENT/FengDingAddServlet" method = "post" onsubmit = "return check()">
...
<!--                                         <option value="公务员">公务员</option> -->
                            ...
                            <div class="am-form-group am-form-warning am-form-icon am-form-feedback" id = "divComp">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" id="ceiling" placeholder="输入封顶线" name = "ceiling">
                                </div>
