...
<script>
	...
	$(function() {
		$.ajax({
			...
			success : function(data) {
				var str = "";
				var cur = $("#curmediId").val();
				$(data).each(
						function(i, p) {
							if(cur == p.mediName){
								str = str + "<option value=" + p.mediName + " selected='selected'>" + p.mediName + "</option>";
							}
							else{
								str = str + "<option value=" + p.mediName + " >" + p.mediName + "</option>";
							}
						});
				$("#medi").html(str);
			},
	...
	function check() {
		if ($("#divId").hasClass("am-form-error")
				|| $("#divmedi").hasClass("am-form-error")) {
			alert("个人编号或药品编号填写错误");
			return false;
		} else {
			return true;
			...
			<div class="tpl-portlet-components">
				<div class="portlet-title">
					<div class="caption font-green bold">
						<span class="am-icon-code"></span>修改特检特治审批
					</div>
					...
					<div class="am-g tpl-amazeui-form">
						<div class="am-u-sm-12 am-u-md-9">
							...
							<form class="am-form am-form-horizontal"
								...
								action="/REIMBURSEMENT/YaoPinSpUpdateServlet2" method="post">
								<div class="am-form-group">
								    <label for="user-weibo" class="am-u-sm-3 am-form-label">审批编号</label>
								    <div class="am-u-sm-9">
								    <input id="user-weibo" 
								        value="${requestScope.p.spID }" type="text" readonly="readonly" name="spID">
								    </div>
							    </div>
									...
									<div
										...
										<div class="am-u-sm-9">
											...
											value="${requestScope.p.personID }"	name="Id">
										</div>
									...
									<div class="am-form-group">
		                                ...
		                                <div class="am-u-sm-9">
		                                    <input type="text" value="${requestScope.p.personName }" id="Name" name="Name" readonly="readonly">
		                                </div>
		                            </div>
									...
									<%-- <div
										class="am-form-group am-form-warning am-form-icon am-form-feedback"
										id="divmedi">
										<label for="user-weibo" class="am-u-sm-3 am-form-label">药品编号</label>
										<div class="am-u-sm-9">
											<input id="medi" class="" placeholder="输入药品编号"
											value="${requestScope.p.mediId }" name="medi" type="text">
										</div>
										<span id="spanmedi" class="am-icon-circle-o"></span>
									</div> --%>
									
									<div class="am-form-group">
										<label for="user-phone" class="am-u-sm-3 am-form-label">药品名称</label>
										<input type="hidden" id="curmediId" value="${requestScope.p.mediId }">
										<div class="am-u-sm-9">
									...
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<input class="am-form-field" data-am-datepicker=""
												 readonly="" required="" placeholder="点击选择日期" type="text"
											value="${requestScope.p.stdate }"	 name="stdate">
										</div>
									</div>
									...
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<input class="am-form-field" data-am-datepicker=""
												 readonly="" required="" placeholder="点击选择日期" type="text"
											value="${requestScope.p.eddate }"	 name="eddate">
										</div>
									</div>
