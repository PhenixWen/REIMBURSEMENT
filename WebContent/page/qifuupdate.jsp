...
// 					alert(str);
		...
		function checkPatientKind()
		{
			var p;
			 $.ajax({
				url:"/REIMBURSEMENT/AjaxCheckStdServlet",
				type:"POST",
				async:false,
...
<div class="tpl-page-container tpl-page-header-fixed">
    ...
    <div class="tpl-content-wrapper">
        ...
        <ol class="am-breadcrumb">
            ...
            <li class="am-active">起付标准信息更改</li>
        </ol>
        ...
        <div class="tpl-portlet-components">
            <div class="portlet-title">
                <div class="caption font-green bold">
                    <span class="am-icon-code"></span>起付标准更改
                </div>
            ...
            <div class="tpl-block ">
                ...
                <div class="am-g tpl-amazeui-form">
					...
					<input type = "hidden" id = "hosrank"  value = "${requestScope.standard.hosRank }">
					<input type = "hidden" id = "curekind"  value = "${requestScope.standard.cureKind }">
					<input type = "hidden" id = "patientkind"  value = "${requestScope.standard.patientKind }">
                    <div class="am-u-sm-12 am-u-md-9">
                    <div class="am-text-center" style="color: red">带黄色圆圈项为必填项</div>
						<br>
                        <form class="am-form am-form-horizontal" action = "/REIMBURSEMENT/QiFuUpdate2Servlet" method = "post" onsubmit = "return check()">
							<div class="am-form-group">
                                <label for="user-weibo" class="am-u-sm-3 am-form-label">数据编号</label>
                                <div class="am-u-sm-9">
                                    <input type="text" id="user-weibo" placeholder="输入起付标准" name = "ide" value = "${requestScope.standard.ide }" readonly="readonly">
                                </div>
                            </div>
                            <div class="am-form-group">
...
<!--                                         <option value="社区医院">社区医院</option> -->
                            ...
                            <div class="am-form-group am-form-warning am-form-icon am-form-feedback" id = "divComp">
                                <label for="user-weibo" class="am-u-sm-3 am-form-label">起付标准</label>
                                <div class="am-u-sm-9">
                                    <input type="text" id="std" placeholder="输入起付标准" name = "std" value = "${requestScope.standard.std }">
                                </div>
