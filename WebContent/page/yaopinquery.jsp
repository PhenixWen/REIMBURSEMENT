...
<head>
    ...
    <script>
    	function check(id){
    		...
    		if(p == true)
    		$.ajax({
    			url:"/REIMBURSEMENT/YaoPinDeleteServlet?mediId="+id,
    			type:"GET",
    			dataType:"text",
    			success:function(data){
    				if(data == "no"){
    					...
    					alert("删除成功");
    					location.href="/REIMBURSEMENT/page/yaopinquery.jsp"; 
    				}
    			},
    			error:function(){
    				alert("error");
        ...
        <div class="tpl-portlet-components">
            <div class="portlet-title">
                <div class="caption font-green bold">
                    <span class="am-icon-code"></span>药品信息
                </div>
            ...
            <div class="tpl-block">
                <div class="am-g">
                    <form class="am-form am-form-inline" method = "post" action = "/REIMBURSEMENT/YaoPinQueryServlet">
                        <label for="doc-ipt-pwd-1">药品编号：</label>
                            <div class="am-form-group">
                                <input type="text" id="doc-ipt-pwd-1" placeholder="编号" name = "mediId">
                            </div>
                        <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                        <label for="doc-ipt-pwd-1">药品名称：</label>
                            <div class="am-form-group">
                                <input type="text"  id="doc-ipt-pwd-1" placeholder="名称" name = "mediName">
                            </div>

                        <br><br>
						<input type = "hidden" value = "0" name = "mark">
                        <label for="doc-ipt-pwd-1">药厂名称：</label>
                            <div class="am-form-group" >
                                <input type="text" id="doc-ipt-pwd-1" placeholder="药厂名称" name = "factorName">
                            </div>
                        <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                        <label for="doc-ipt-pwd-1">国药准字：</label>
                            <div class="am-form-group" >
                                <input type="text" id="doc-ipt-pwd-1" placeholder="国药准字" name = "drugCertificate">
                            </div>
                        <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                        <button type="submit" class="am-btn am-btn-primary">查询</button>
                        <button type="button" class="am-btn am-btn-primary am-btn-success" onclick="window.open('/REIMBURSEMENT/page/yaopinadd.jsp')" >
                    ...
                    <div class="am-u-sm-12">
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                <thead>
                                <tr>
                                    <th class="table-type">药品编号</th>
                                    <th class="table-type">药品名称</th>
                                    <th class="table-type">收费类别</th>
                                    <th class="table-type">医院等级</th>
                                    <th class="table-type">药厂名称</th>
                                    <th class="table-type">审批标志</th>
...
<%--                                     <c:forEach items = "${requestScope.yaopinlist }" var = "y"> --%>
<!--                                     	<tr> -->
<%--                                     		<td>${y.mediId }</td> --%>
<%-- 	                                    	<td>${y.mediName }</td> --%>
<%-- 	                                    	<td>${y.feeKind }</td> --%>
...
<%-- 		                                                <button type = "button" class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="window.location.href='/REIMBURSEMENT/YaoPinUpdate1Servlet?mediId=${y.mediId }'"><span --%>
<!-- 		                                                        class="am-icon-pencil-square-o"></span>编辑 -->
<!-- 		                                                </button> -->
<%-- 		                                                <button type = "button" class="am-btn am-btn-default am-btn-xs am-hide-sm-only" onclick="window.location.href='/REIMBURSEMENT/YaoPinDetailServlet?mediId=${y.mediId }'"><span --%>
<!-- 		                                                        class="am-icon-copy"></span>详情 -->
<!-- 		                                                </button> -->
<%-- 		                                                <button type = "button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="window.location.href='/REIMBURSEMENT/YaoPinDeleteServlet?mediId=${y.mediId }'"> --%>
								        ...
								        <td>
	                                        <div class="am-btn-toolbar">
	                                            <div class="am-btn-group am-btn-group-xs">
	                                                ...
	                                                <button type = "button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="check(${y.mediId })">
	                                                    <span class="am-icon-trash-o"></span>删除
	                                                </button>
	                                            </div>
	                                        </div>
                                ...
                                <div class="am-fr">
                                    ...
                                    <c:forEach begin="1" step="1" end="${requestScope.pages}" var="i">
									    ...
									    <c:if test="${i eq requestScope.curpage }">
									    	<li class="am-active">
									    	<a href="/REIMBURSEMENT/YaoPinQueryServlet?page=${i }&mediId=${requestScope.mediId}&mediName=${requestScope.mediName}&factorName=${requestScope.factorName}&drugCertificate=${requestScope.drugCertificate}&mark=1">${i }</a>
									    	</li>
									    </c:if>
