...
// 					alert(str);
		...
		$(function(){
			$("#servName").blur(function(){
				var value = $("#servName").val();
				if(value != ''){
					$("#divComp")
						.attr("class",
...
<div class="tpl-page-container tpl-page-header-fixed">
    ...
    <div class="tpl-content-wrapper">
        ...
        <ol class="am-breadcrumb">
            ...
            <li class="am-active">服务设施项目更改</li>
        </ol>
        ...
        <div class="tpl-portlet-components">
            <div class="portlet-title">
                <div class="caption font-green bold">
                    <span class="am-icon-code"></span>服务设施项目更改
                </div>
            ...
            <div class="tpl-block ">
                ...
                <div class="am-g tpl-amazeui-form">
					...
					<input type = "hidden" id = "feekind"  value = "${requestScope.service.feeKind }">
                    <div class="am-u-sm-12 am-u-md-9">
                    <div class="am-text-center" style="color: red">带黄色圆圈项为必填项</div>
						<br>
                        <form class="am-form am-form-horizontal" action = "/REIMBURSEMENT/FuWuUpdate2Servlet" method = "post" onsubmit = "return check()">
                            <div class="am-form-group">
                                <label for="user-name" class="am-u-sm-3 am-form-label">服务设施编号</label>
                                <div class="am-u-sm-9">
                                    <input type="text" id="user-name" placeholder="输入设施编号" name = "servId" value = "${requestScope.service.servId }" readonly="readonly">
                            ...
                            <div class="am-form-group am-form-warning am-form-icon am-form-feedback" id = "divComp">
                                <label for="user-email" class="am-u-sm-3 am-form-label">服务设施名称</label>
                                <div class="am-u-sm-9">
                                    <input type="text" id="servName" placeholder="输入设施名称" name = "servName" value = "${requestScope.service.servName }">
...
<!--                                         <option value="丙">丙</option> -->
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" id="user-weibo" placeholder="输入使用范围" name = "rge" value = "${requestScope.service.rge }">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label for="user-weibo" class="am-u-sm-3 am-form-label">备注</label>
                                <div class="am-u-sm-9">
                                    <input type="text" id="user-weibo" placeholder="备注" name = "remarks" value = "${requestScope.service.remarks }">
                                </div>
                            </div>
                            <div class="am-form-group">
