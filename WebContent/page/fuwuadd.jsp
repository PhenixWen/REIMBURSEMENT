...
<head>
	...
	$(function() {
		$("#servId")
				.blur(
						function() {
							var value = $("#servId").val();
							$
									.ajax({
										url : "/REIMBURSEMENT/AjaxCheckServId?servId="
												+ value,
										type : "GET",
										dataType : "text",
...
<div class="tpl-page-container tpl-page-header-fixed">
    ...
    <div class="tpl-content-wrapper">
        ...
        <ol class="am-breadcrumb">
            ...
            <li class="am-active">服务设施项目添加</li>
        </ol>
        ...
        <div class="tpl-portlet-components">
            <div class="portlet-title">
                <div class="caption font-green bold">
                    <span class="am-icon-code"></span>服务设施项目添加
                </div>
            ...
            <div class="tpl-block ">
                ...
                <div class="am-g tpl-amazeui-form">
                    ...
                    <div class="am-u-sm-12 am-u-md-9">
						...
						<br>
                        <form class="am-form am-form-horizontal" action = "/REIMBURSEMENT/FuWuAddServlet" method = "post" onsubmit = "return check()">
                            <div class="am-form-group am-form-warning am-form-icon am-form-feedback" id = "divComp">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" id="servId" placeholder="输入设施编号" name = "servId">
                            ...
                            <div class="am-form-group am-form-warning am-form-icon am-form-feedback" id = "divComp2">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" id="servName" placeholder="输入设施名称" name = "servName">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <select data-am-selected="{searchBox: 1, maxHeight: 100}" style="display: none;" name = "feeKind">
