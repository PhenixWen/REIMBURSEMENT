...
<div class="tpl-page-container tpl-page-header-fixed">
    ...
    <div class="tpl-content-wrapper">
        ...
        <ol class="am-breadcrumb">
            ...
            <li><a href="/REIMBURSEMENT/page/qifuquery.jsp">起付标准</a></li>
        </ol>
        ...
        <div class="tpl-portlet-components">
            <div class="portlet-title">
                <div class="caption font-green bold">
                    <span class="am-icon-code"></span>起付标准
                </div>
            ...
            <div class="tpl-block">
                <div class="am-g">
                    <form class="am-form am-form-inline" method = "post" action = "/REIMBURSEMENT/QiFuQueryServlet">
                        <label for="doc-ipt-pwd-1">数据编号：</label>
                            <div class="am-form-group">
                                <input type="text"  id="doc-ipt-pwd-1" placeholder="编号" name = "ide">
                            </div>
...
<!--                                         <option value="社区医院">社区医院</option> -->
                        ...
                        <button type="button" class="am-btn am-btn-primary am-btn-success" onclick="window.open('/REIMBURSEMENT/page/qifuadd.jsp')" >
                    ...
                    <div class="am-u-sm-12">
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                <thead>
                                <tr>
                                    <th class="table-type">起付标准编号</th>
                                    <th class="table-type">医疗类别</th>
                                    <th class="table-type">医疗人员类别</th>
                                    <th class="table-type">医院等级</th>
                                    <th class="table-type">起付标准</th>
                                </tr>
                                </thead>
                                <tbody>
<!--                                 <tr> -->
<%--                                      <c:forEach items = "${requestScope.qifulist }" var = "q"> --%>
<!--                                      	<tr> -->
<%--                                      		<td>${q.ide }</td> --%>
<%-- 	                                    	<td>${q.cureKind }</td> --%>
<%-- 	                                    	<td>${q.patientKind }</td> --%>
...
<%-- 		                                                <button type = "button" class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="window.location.href='/REIMBURSEMENT/QiFuUpdate1Servlet?ide=${q.ide }'"><span --%>
<!-- 		                                                        class="am-icon-pencil-square-o"></span>编辑 -->
<!-- 		                                                </button> -->
<%-- 		                                                <button type = "button" class="am-btn am-btn-default am-btn-xs am-hide-sm-only" onclick="window.location.href='/REIMBURSEMENT/QiFuDetailServlet?ide=${q.ide }'"><span --%>
<!-- 		                                                        class="am-icon-copy"></span>详情 -->
<!-- 		                                                </button> -->
<%-- 		                                                <button type = "button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="window.location.href='/REIMBURSEMENT/QiFuDeleteServlet?ide=${q.ide }'"> --%>
                                ...
                                <div class="am-fr">
                                    ...
                                    <c:forEach begin="1" step="1" end="${requestScope.pages}" var="i">
									    ...
									    <c:if test="${i eq requestScope.curpage }">
									    	<li class="am-active">
									    	<a href="/REIMBURSEMENT/QiFuQueryServlet?page=${i }&ide=${requestScope.ide}&cureKind=${requestScope.cureKind}&hosRank=${requestScope.hosRank}&patientKind=${requestScope.patientKind}&mark=1">${i }</a>
									    	</li>
									    </c:if>
