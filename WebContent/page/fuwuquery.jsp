...
<html class="js cssanimations"><head>
    ...
    <script>
    	function check(id){
    		...
    		if(p == true)
    		$.ajax({
    			url:"/REIMBURSEMENT/FuWuDeleteServlet?servId="+id,
    			type:"GET",
    			dataType:"text",
    			success:function(data){
    				if(data == "no"){
    					...
    					alert("删除成功");
    					location.href="/REIMBURSEMENT/page/fuwuquery.jsp"; 
    				}
    			},
    			error:function(){
    				alert("error");
...
<div class="tpl-page-container tpl-page-header-fixed">
    ...
    <div class="tpl-content-wrapper">
        ...
        <ol class="am-breadcrumb">
            ...
            <li><a href="/REIMBURSEMENT/page/fuwuquery.jsp">服务设施项目信息</a></li>
        </ol>
        ...
        <div class="tpl-portlet-components">
            <div class="portlet-title">
                <div class="caption font-green bold">
                    <span class="am-icon-code"></span>服务设施项目信息
                </div>
            ...
            <div class="tpl-block">
                <div class="am-g">
                    <form class="am-form am-form-inline" method = "post" action = "/REIMBURSEMENT/FuWuQueryServlet">
                        <label for="doc-ipt-pwd-1">服务设施项目编号：</label>
                            <div class="am-form-group">

                                <input type="text" id="doc-ipt-pwd-1" placeholder="编号" name = "servId">
                            </div>
                        <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                        <label for="doc-ipt-pwd-2">服务设施项目名称：</label>
                            <div class="am-form-group">

                                <input type="text" id="doc-ipt-pwd-2" placeholder="名称" name = "servName">
                            </div>
                        <span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
						<input type = "hidden" name = "mark" value = "0">
                        <button type="submit" class="am-btn am-btn-primary">查询</button>
                        <button type="button" class="am-btn am-btn-primary am-btn-success" onclick="window.open('/REIMBURSEMENT/page/fuwuadd.jsp')" >
                    ...
                    <div class="am-u-sm-12">
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                <thead>
                                <tr>
                                    <th class="table-type">服务设施编号</th>
                                    <th class="table-type">服务设施名称</th>
                                    <th class="table-type">收费类别</th>
                                    <th class="table-type">限制使用范围</th>
                                ...
                                <tbody>
<!--                                 <tr> -->
<%--                                      <c:forEach items = "${requestScope.fuwulist }" var = "f"> --%>
<!--                                      	<tr> -->
<%--                                      		<td>${f.servId }</td> --%>
<%-- 	                                    	<td>${f.servName }</td> --%>
<%-- 	                                    	<td>${f.feeKind }</td> --%>
...
<%-- 		                                                <button type = "button" class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="window.location.href='/REIMBURSEMENT/FuWuUpdate1Servlet?servId=${f.servId }'"><span --%>
<!-- 		                                                        class="am-icon-pencil-square-o"></span>编辑 -->
<!-- 		                                                </button> -->
<%-- 		                                                <button type = "button" class="am-btn am-btn-default am-btn-xs am-hide-sm-only" onclick="window.location.href='/REIMBURSEMENT/FuWuDetailServlet?servId=${f.servId }'"><span --%>
<!-- 		                                                        class="am-icon-copy"></span>详情 -->
<!-- 		                                                </button> -->
<%-- 		                                                <button type = "button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="window.location.href='/REIMBURSEMENT/FuWuDeleteServlet?servId=${f.servId }'"> --%>
								        ...
								        <td>
	                                         <div class="am-btn-toolbar">
		                                            <div class="am-btn-group am-btn-group-xs">
		                                                ...
		                                                <button type = "button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="check(${f.servId })">
		                                                    <span class="am-icon-trash-o"></span>删除
		                                                </button>
		                                            </div>
		                                        </div>
                                ...
                                <div class="am-fr">
                                    ...
                                    <c:forEach begin="1" step="1" end="${requestScope.pages}" var="i">
									    ...
									    <c:if test="${i eq requestScope.curpage }">
									    	<li class="am-active">
									    	<a href="/REIMBURSEMENT/FuWuQueryServlet?page=${i }&servId=${requestScope.servId}&servName=${requestScope.servName}&mark=1">${i }</a>
									    	</li>
									    </c:if>
