        ...
        <div class="tpl-portlet-components">
            <div class="portlet-title">
                <div class="caption font-green bold">
                    <span class="am-icon-code"></span>封顶线更改
            ...
            <div class="tpl-block ">
                ...
                <div class="am-g tpl-amazeui-form">
                    ...
                    <div class="am-text-center" style="color: red">带黄色圆圈项为必填项</div>
							<br>
                        <form class="am-form am-form-horizontal" action = "/REIMBURSEMENT/FengDingUpdate2Servlet" method = "post" onsubmit = "return check()">

                            <div class="am-form-group">
                                <label for="user-weibo" class="am-u-sm-3 am-form-label">数据编号</label>
                                <div class="am-u-sm-9">
                                    <input type="text" id="user-weibo" name = "ide" value = "${requestScope.ceil.ide }" readonly = "readonly">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label for="user-weibo" class="am-u-sm-3 am-form-label">医疗人员类别</label>
                                <div class="am-u-sm-9">
                                    <input type="text" id="user-weibo" placeholder="输入封顶线" name = "patientKind" value = "${requestScope.ceil.patientKind }" readonly = "readonly">
                                </div>
                            </div>

                            <div class="am-form-group am-form-warning am-form-icon am-form-feedback" id = "divComp">
                                <label for="user-weibo" class="am-u-sm-3 am-form-label">封顶线</label>
                                <div class="am-u-sm-9">
                                    <input type="text" id="ceiling" placeholder="输入封顶线" name = "ceiling" value = "${requestScope.ceil.ceiling }">
                                </div>
