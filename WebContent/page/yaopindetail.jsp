    ...
    <div class="tpl-content-wrapper">
        ...
        <div class="tpl-portlet-components">
            ...
            <table style="  text-align:center;  table-layout:fixed; background-color:white" class="am-table  am-table-striped am-table-hover am-table-compact am-table-bordered am-table-radius am-table-striped">
                <tbody>
                <tr>
                    <td style="color: black">药品编码</td>
                    <td style="color: black">${requestScope.medicine.mediId }</td>
                </tr>
                <tr>
                    <td style="color: black">药品名称</td>
                    <td style="color: black">${requestScope.medicine.mediName }</td>
                </tr>
                <tr>
                    <td style="color: black">收费类别</td>
                    <td style="color: black">${requestScope.medicine.feeKind }</td>
                </tr>
                <tr>
                    <td style="color: black">收费项目等级</td>
                    <td style="color: black">${requestScope.medicine.chargeRank}</td>
                </tr>
                <tr>
                    <td style="color: black">审批标志</td>
                    <td style="color: black">${requestScope.medicine.examine}</td>
                </tr>
                <tr>
                    <td style="color: black">最高限价</td>
                    <td style="color: black">${requestScope.medicine.ceilingPri }</td>
                </tr>
                <tr>
                    <td style="color: black">医院等级</td>
                    <td style="color: black">${requestScope.medicine.hosRank }</td>
                </tr>
                <tr>
                    <td style="color: black">药厂名称</td>
                    <td style="color: black">${requestScope.medicine.factorName }</td>
                </tr>
                <tr>
                    <td style="color: black">国药准字</td>
                    <td style="color: black">${requestScope.medicine.drugCertificate }</td>
                </tr>
                <tr>
                    <td style="color: black">使用频次</td>
                    <td style="color: black">${requestScope.medicine.useFrequency }</td>
                </tr>
                <tr>
                    <td style="color: black">使用方法</td>
                    <td style="color: black">${requestScope.medicine.useMethod }</td>
                </tr>
                <tr>
                    <td style="color: black">产地</td>
                    <td style="color: black">${requestScope.medicine.place }</td>
                </tr>
                <tr>
                    <td style="color: black">限定天数</td>
                    <td style="color: black">${requestScope.medicine.dayy }</td>
                </tr>
                <tr>
                    <td style="color: black">备注</td>
                    <td style="color: black">${requestScope.medicine.remarks }</td>
                </tr>
                </tbody>
            </table>
