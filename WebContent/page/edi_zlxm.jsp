	...
	<script>
	 function returnFloat(value){
    	...
    	function golis(){
    		...
    		var url = "/REIMBURSEMENT/msg_zlxm?personId=";
    		if(personId !== null && personId !== undefined && personId !== '') url = url+personId;
    		else url = url+personId0;
    		url = url + "&solveid=";
		...
		function projName() {
    		$.ajax({
				url:"/REIMBURSEMENT/add_zlxm_ajax",
				type:"GET",
				dataType:"json",
				success:function(data){
					var curprojId = $("#curprojId").val();
					var str="";
					$(data).each(function(i,zl){
						if(zl.projId != curprojId){
							str= str + "<option value=" + zl.projId + ">" + zl.projName+ "</option>";
						}
						else{
							str= str + "<option value=" + zl.projId + " selected='selected'>" + zl.projName + "</option>";
						}
					});
					$("#projName").html(str);
				},
...
<body onload = "fun1();fun2();projName();price();num();" data-type="generalComponents">
...
<div class="tpl-page-container tpl-page-header-fixed">
    ...
    <div class="tpl-content-wrapper">
        ...
        <ol class="am-breadcrumb">
            ...
            <li><a href="javascript:void(0);" onclick ="golis()">诊疗项目明细信息</a></li>
            <li class="am-active">修改诊疗项目明细</li>
        </ol>
        ...
        <div class="tpl-portlet-components">
            <div class="portlet-title">
                <div class="caption font-green bold">
                    <span class="am-icon-code"></span>修改诊疗项目明细
                </div>
            ...
            <div class="tpl-block ">
                ...
                <div class="am-g tpl-amazeui-form">
                    ...
                    <div class="am-text-center" style="color: red">带黄色圆圈项为必填项</div>
						<form style="padding-left:100px;" action="/REIMBURSEMENT/edi_zlxm2?ide=${requestScope.lis.ide}" method="post" class="am-form am-form-horizontal">
                            ...
                            <div class="am-form-group">
                                ...
                                <input type="hidden" id="curprojId" value="${requestScope.lis.projId}">
                                <div class="am-u-sm-9">
<select id="projName" data-am-selected="{searchBox: 1, maxHeight: 100}"style="display: none;" name="projId"></select>
                                </div>
                            </div>
