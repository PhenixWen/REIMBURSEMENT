...
<div class="tpl-page-container tpl-page-header-fixed">
    ...
    <div class="tpl-content-wrapper">
        ...
        <ol class="am-breadcrumb">
            ...
            <li class="am-active">起付标准信息添加</li>
        </ol>
        ...
        <div class="tpl-portlet-components">
            <div class="portlet-title">
                <div class="caption font-green bold">
                    <span class="am-icon-code"></span>起付标准添加
                </div>
            ...
            <div class="tpl-block ">
                ...
                <div class="am-g tpl-amazeui-form">
                    ...
                    <div class="am-u-sm-12 am-u-md-9">
						...
						<br>
                        <form class="am-form am-form-horizontal" action = "/REIMBURSEMENT/QiFuAddServlet" method = "post" onsubmit = "return check()">
...
<!--                                         <option value="社区医院">社区医院</option> -->
                            ...
                            <div class="am-form-group am-form-warning am-form-icon am-form-feedback" id = "divComp">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" id="std" placeholder="输入起付标准" name = "std">
                                </div>
