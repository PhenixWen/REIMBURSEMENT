			...
			<div class="tpl-portlet-components">
				<div class="portlet-title">
					<div class="caption font-green bold">
						<span class="am-icon-code"></span>添加人员就诊机构审批
					</div>
					...
					<div class="am-g tpl-amazeui-form">
						<div class="am-u-sm-12 am-u-md-9">
							...
							<form class="am-form am-form-horizontal"
								...
								action="/REIMBURSEMENT/JiGouSpInsertServlet" method="post">


									<div
										class="am-form-group am-form-warning am-form-icon am-form-feedback"
										id="divId">
										<label for="user-weibo" class="am-u-sm-3 am-form-label">申请人编码</label>
										<div class="am-u-sm-9">
											<input id="Id" class="" placeholder="输入申请人编码" type="text"
												name="Id">
										</div>
