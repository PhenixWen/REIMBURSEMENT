...
<html class="js cssanimations"><head>
    ...
    <script>
	    function check(id){
			...
			if(p == true)
			$.ajax({
				url:"/REIMBURSEMENT/JiGouSpDeleteServlet?no="+id,
				type:"GET",
				dataType:"text",
				success:function(data){
					alert("删除成功");
					location.href="/REIMBURSEMENT/page/jigousp.jsp"; 
				},
				error:function(){
					alert("error");
				}
...
<div class="tpl-page-container tpl-page-header-fixed">
    ...
    <div class="tpl-content-wrapper">
        ...
        <ol class="am-breadcrumb">
            ...
            <li class="am-active">人员就诊机构审批</li>
        </ol>
        <div class="tpl-portlet-components">
            <div class="portlet-title">
                <div class="caption font-green bold">
                    <span class="am-icon-code"></span>人员就诊机构审批
                </div>
            ...
            <div class="tpl-block">
                <div class="am-u-md-12 am-u-sm-centered">
                    <form class="am-form am-form-inline" action="/REIMBURSEMENT/JiGouSpQueryServlet" method="post">
                        <label for="doc-ipt-3" class="am-form-label">个人编号: </label>
                        
                        <div class="am-form-group">
                            <input value="${requestScope.pid }" 
                            class="am-form-field" placeholder="编号" name="pid" type="text">
                        </div>
                        <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                        
                        
                        <button type="submit" class="am-btn am-btn-primary ">查询</button>
                        <button type="button" class="am-btn am-btn-default am-btn-success" onclick="window.open('/REIMBURSEMENT/page/jigousp_add.jsp')">
                        ...
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                ...
                                <tr>
                                    ...
                                    <th class="table-author am-hide-sm-only">申请医疗机构</th>
                                    ...
                                    <ul class="am-pagination tpl-pagination">
                                        <c:forEach begin="1" step="1" end="${requestScope.pages}" var="i">
										    ...
										    <c:if test="${i eq requestScope.curpage }">
										    	<li class="am-active">
										    	<a href="/REIMBURSEMENT/JiGouSpQueryServlet?page=${i }&pid=${requestScope.pid }">${i }</a>
										    	</li>
										    </c:if>
