...
<html class="js cssanimations"><head>
    ...
    <script>
    	function check(id){
    		...
    		if(p == true)
    		$.ajax({
    			url:"/REIMBURSEMENT/ZhenLiaoDeleteServlet?projId="+id,
    			type:"GET",
    			dataType:"text",
    			success:function(data){
    				if(data == "no"){
    					alert("该诊疗项目正在被使用，无法删除");
    					
    				}else{
    					alert("删除成功");
    					location.href="/REIMBURSEMENT/page/zhenliaoquery.jsp"; 
    				}
    			},
    			error:function(){
    				alert("error");
        ...
        <div class="tpl-portlet-components">
            <div class="portlet-title">
                <div class="caption font-green bold">
                    <span class="am-icon-code"></span>诊疗项目信息
                </div>
            ...
            <div class="tpl-block">
                <div class="am-g">
                    <form class="am-form am-form-inline" method = "post" action = "/REIMBURSEMENT/ZhenLiaoQueryServlet">
                        <label for="doc-ipt-pwd-1">诊疗项目编号：</label>
                            <div class="am-form-group">
                                <input type="text" id="doc-ipt-pwd-1" placeholder="编号" name = "projId">
                            </div>
                        <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                        <label for="doc-ipt-pwd-1">诊疗项目名称：</label>
                            <div class="am-form-group" >
                                <input type="text"  id="doc-ipt-pwd-1" placeholder="名称" name = "projName">
                            </div>
						<input type = "hidden" name = "mark" value = "0">
                        <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                        <button type="submit" class="am-btn am-btn-primary">查询</button>
                        <button type="button" class="am-btn am-btn-primary am-btn-success" onclick="window.open('/REIMBURSEMENT/page/zhenliaoadd.jsp')" >
                    ...
                    <div class="am-u-sm-12">
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                <thead>
                                <tr>
                                    <th class="table-type">诊疗项目编号</th>
                                    <th class="table-type">诊疗项目名称</th>
                                    <th class="table-type">收费类别</th>
                                    <th class="table-type">医院等级</th>
                                    <th class="table-type">生产厂家</th>
                                    <th class="table-set">操作</th>
                                </tr>
                                </thead>
                                <tbody>
<!--                                 <tr> -->
<%--                                      <c:forEach items = "${requestScope.zhenliaolist }" var = "z"> --%>
<!--                                      	<tr> -->
<%--                                      		<td>${z.projId }</td> --%>
<%-- 	                                    	<td>${z.projName }</td> --%>
<%-- 	                                    	<td>${z.feeKind }</td> --%>
<%-- 	                                    	<td>${z.hosRank }</td> --%>
<%-- 	                                    	<td>${z.manufacturer }</td> --%>
<!-- 	                                    	<td> -->
<!-- 		                                        <div class="am-btn-toolbar"> -->
<!-- 		                                            <div class="am-btn-group am-btn-group-xs"> -->
<%-- 		                                                <button type = "button" class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="window.location.href='/REIMBURSEMENT/ZhenLiaoUpdate1Servlet?projId=${z.projId }'"><span --%>
<!-- 		                                                        class="am-icon-pencil-square-o"></span>编辑 -->
<!-- 		                                                </button> -->
<%-- 		                                                <button type = "button" class="am-btn am-btn-default am-btn-xs am-hide-sm-only" onclick="window.location.href='/REIMBURSEMENT/ZhenLiaoDetailServlet?projId=${z.projId }'"><span --%>
<!-- 		                                                        class="am-icon-copy"></span>详情 -->
<!-- 		                                                </button> -->
<%-- 		                                                <button type = "button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="window.location.href='/REIMBURSEMENT/ZhenLiaoDeleteServlet?projId=${z.projId }'"> --%>
								        ...
								        <td>
	                                        <div class="am-btn-toolbar">
		                                            <div class="am-btn-group am-btn-group-xs">
		                                                ...
		                                                <button type = "button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="check(${z.projId })">
		                                                    <span class="am-icon-trash-o"></span>删除
		                                                </button>
		                                            </div>
		                                        </div>
                                ...
                                <div class="am-fr">
                                    ...
                                    <c:forEach begin="1" step="1" end="${requestScope.pages}" var="i">
									    ...
									    <c:if test="${i eq requestScope.curpage }">
									    	<li class="am-active">
									    	<a href="/REIMBURSEMENT/ZhenLiaoQueryServlet?page=${i }&projId=${requestScope.projId}&projName=${requestScope.projName}&mark=1">${i }</a>
									    	</li>
									    </c:if>
