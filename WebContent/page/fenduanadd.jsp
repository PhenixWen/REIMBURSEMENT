...
// 					alert(str);
		...
		function check() {
			if ($("#divComp").hasClass("am-form-success") && $("#divComp2").hasClass("am-form-success") && $("#divComp3").hasClass("am-form-success")) {
				return true;
			} else {
				alert("请按要求填写");
				return false;
...
<div class="tpl-page-container tpl-page-header-fixed">
    ...
    <div class="tpl-content-wrapper">
        ...
        <ol class="am-breadcrumb">
            ...
            <li class="am-active">个人分段自费比例添加</li>
        </ol>
        ...
        <div class="tpl-portlet-components">
            <div class="portlet-title">
                <div class="caption font-green bold">
                    <span class="am-icon-code"></span>个人分段自费比例添加
                </div>
            ...
            <div class="tpl-block ">
                ...
                <div class="am-g tpl-amazeui-form">
                    ...
                    <div class="am-text-center" style="color: red">带黄色圆圈项为必填项</div>
							<br>
                        <form class="am-form am-form-horizontal" action = "/REIMBURSEMENT/FenDuanAddServlet" method = "post" onsubmit = "return check()">
...
<!--                                         <option value="社区医院">社区医院</option> -->
                            ...
                            <div class="am-form-group am-form-warning am-form-icon am-form-feedback" id = "divComp">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" id="ceiling" placeholder="输入上限金额" name = "ceiling">
                                </div>
                            ...
                            <div class="am-form-group am-form-warning am-form-icon am-form-feedback" id = "divComp2">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" id="floor" placeholder="输入下限金额" name = "floor">
                                </div>
                            ...
                            <div class="am-form-group am-form-warning am-form-icon am-form-feedback" id = "divComp3">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" id="ratio" placeholder="输入报销比例" name = "ratio">
                                </div>
