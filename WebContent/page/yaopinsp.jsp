...
<%--<%@page import="hrbeu.entity.Person"%>--%>
...
<html class="js cssanimations"><head>
    ...
    <script>
	    function check(id){
			...
			if(p == true)
			$.ajax({
				url:"/REIMBURSEMENT/YaoPinSpDeleteServlet?no="+id,
				type:"GET",
				dataType:"text",
				success:function(data){
					alert("删除成功");
					location.href="/REIMBURSEMENT/page/yaopinsp.jsp"; 
				},
				error:function(){
					alert("error");
				}
...
<div class="tpl-page-container tpl-page-header-fixed">
    ...
    <div class="tpl-content-wrapper">
        ...
        <ol class="am-breadcrumb">
            ...
            <li><a href="#">医疗待遇审批</a></li>
            <li class="am-active">特检特治审批</li>
        </ol>
        <div class="tpl-portlet-components">
            <div class="portlet-title">
                <div class="caption font-green bold">
                    <span class="am-icon-code"></span>特检特治审批
                </div>
            ...
            <div class="tpl-block">
                <div class="am-u-md-12 am-u-sm-centered">
                    <form class="am-form am-form-inline" action="/REIMBURSEMENT/YaoPinSpQueryServlet" method="post">
                        <label for="doc-ipt-3" class="am-form-label">个人编号: </label>
                        
                        <div class="am-form-group">
                            <input value="${requestScope.pid }"  class="am-form-field" placeholder="编号" name="pid" type="text">
                        </div>
                        <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                        
                        
                        <button type="submit" class="am-btn am-btn-primary ">查询</button>
                        <button type="button" class="am-btn am-btn-default am-btn-success" onclick="window.open('/REIMBURSEMENT/page/yaopinsp_add.jsp')">
                    ...
                    <div class="am-u-sm-12">
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                <thead>
                                <tr>
                                    <th class="table-author am-hide-sm-only">审批编号</th>
                                    <th class="table-title">申请人编号</th>
                                    <th class="table-type">申请人姓名</th>
                                    <th class="table-author am-hide-sm-only">申请药品</th>
                                    <th class="table-set">申请日期</th>
                                    <th class="table-set">结束日期</th>
                                    <th class="table-set">申请状态</th>
							        ...
							        <td>
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                            	<button class="am-btn am-btn-default am-btn-xs am-text-success" type="button"
                                                    onclick="window.location.href='/REIMBURSEMENT/YaoPinSpOk?no=${p.spID }'">
                                    				<span class="am-icon-check-square-o "></span> 改为已通过
                                                </button> 
                                                
                                            	<button class="am-btn am-btn-default am-btn-xs am-text-danger" type="button"
                                                    onclick="window.location.href='/REIMBURSEMENT/YaoPinSpNo?no=${p.spID }'">
                                    				<span class="am-icon-close "></span> 改为未通过
                                                </button> 
                                                
                                                <button class="am-btn am-btn-default am-btn-xs am-text-secondary" type="button"
         				                          onclick="window.location.href='/REIMBURSEMENT/YaoPinSpUpdateServlet1?no=${p.spID }'">
                                    				<span class="am-icon-pencil-square-o"></span> 编辑
                                                </button>
                                                
                                                <button class="am-btn am-btn-default am-btn-xs am-text-danger" type="button" onclick="check(${p.spID })">
                                    ...
                                    <ul class="am-pagination tpl-pagination">
                                        ...
                                        <c:forEach begin="1" step="1" end="${requestScope.pages}" var="i">
										    ...
										    <c:if test="${i eq requestScope.curpage }">
										    	<li class="am-active">
										    	<a href="/REIMBURSEMENT/YaoPinSpQueryServlet?page=${i }&pid=${requestScope.pid } ">${i }</a>
										    	</li>
										    </c:if>
