...
<div class="tpl-page-container tpl-page-header-fixed">
    ...
    <div class="tpl-content-wrapper">
        ...
        <ol class="am-breadcrumb">
            ...
            <li class="am-active">定点医疗机构信息详情</li>
        </ol>
        ...
        <div class="tpl-portlet-components">
            ...
            <table style="  text-align:center;  table-layout:fixed; background-color:white" class="am-table  am-table-striped am-table-hover am-table-compact am-table-bordered am-table-radius am-table-striped">
                <tbody>
                <tr>
                    <td style="color: black">定点医疗机构编码</td>
                    <td style="color: black">${requestScope.company.compId }</td>
                </tr>
                <tr>
                    <td style="color: black">医疗机构名称</td>
                    <td style="color: black">${requestScope.company.compName }</td>
                </tr>
                <tr>
                    <td style="color: black">医院等级</td>
                    <td style="color: black">${requestScope.company.hosRank }</td>
                </tr>
                <tr>
                    <td style="color: black">医疗机构类别</td>
                    <td style="color: black">${requestScope.company.kind }</td>
                </tr>
                <tr>
                    <td style="color: black">联系人电话</td>
                    <td style="color: black">${requestScope.company.nam }</td>
                </tr>
                <tr>
                    <td style="color: black">联系人姓名</td>
                    <td style="color: black">${requestScope.company.tel }</td>
                </tr>
                <tr>
                    <td style="color: black">备注</td>
                    <td style="color: black">${requestScope.company.remarks }</td>
                </tr>
                </tbody>
            </table>
