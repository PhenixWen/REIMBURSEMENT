		...
		$("#compId")
				.blur(
						function() {
							...
							$
									.ajax({
										url : "/REIMBURSEMENT/AjaxCheckCompIdyz?compId="
												+ value,
										type : "GET",
										dataType : "text",
...
<div class="tpl-page-container tpl-page-header-fixed">
    ...
    <div class="tpl-content-wrapper">
        ...
        <ol class="am-breadcrumb">
            ...
            <li class="am-active">定点医疗机构信息添加</li>
        </ol>
        ...
        <div class="tpl-portlet-components">
            <div class="portlet-title">
                <div class="caption font-green bold">
                    <span class="am-icon-code"></span>定点医疗机构信息添加
                </div>
            ...
            <div class="tpl-block ">
                ...
                <div class="am-g tpl-amazeui-form">
                    ...
                    <div class="am-u-sm-12 am-u-md-9">
						...
						<br>
                        <form class="am-form am-form-horizontal" action = "/REIMBURSEMENT/JiGouAddServlet" method = "post" onsubmit = "return check()">
                            <div class="am-form-group am-form-warning am-form-icon am-form-feedback" id = "divComp">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" id="compId" placeholder="输入机构编号" name = "compId">
                            ...
                            <div class="am-form-group am-form-warning am-form-icon am-form-feedback" id = "divComp2">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" id="compName" placeholder="输入机构名称" name = "compName">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <select data-am-selected="{searchBox: 1, maxHeight: 100}" style="display: none;" name = "hosRank">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" id="user-weibo" placeholder="输入联系人姓名" name = "nam">
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" id="user-weibo" placeholder="输入联系人电话" name = "tel">
                                </div>
                            </div>
