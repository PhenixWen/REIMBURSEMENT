...
$(function() {
	$.ajax({
		url : "/REIMBURSEMENT/AjaxGetIns",
		type : "GET",
		dataType : "json",
		success : function(data) {
			var cur = $("#curinsID").val();
			
			var str = "";
			$(data).each(
					function(i, p) {
						if(cur == p.insID){
							str = str + "<option value=" + p.insID + " selected='selected'>"
							+ p.insName + "</option>";
						}
						else{
							str = str + "<option value=" + p.insID + ">"
							+ p.insName + "</option>";
						}
...
$(function() {
$.ajax({
	url : "/REIMBURSEMENT/AjaxGetComp",
	type : "GET",
	dataType : "json",
	success : function(data) {
		var str = "";
		var cur = $("#curcompID").val();
		$(data).each(
				function(i, p) {
 					
					if(cur == p.compId){
						
						str = str + "<option value=" + p.compId + " selected='selected'>"
						+ p.compName + "</option>";
					}
					else{
						str = str + "<option value=" + p.compId + ">"
						+ p.compName + "</option>";
					}
	...
	$(function(){
		$.ajax({
			...
			success:function(data){
				...
				var curpat = $("#curpat").val();
				var str="";
				$(data).each(function(i,p){
					
					if(p.id == curpat){
						str= str + "<option value=" + p.id + " selected='selected'>" + p.patientKind + "</option>";
					}
					else{
						str= str + "<option value=" + p.id + ">" + p.patientKind + "</option>";
					}
				});
				$("#pat").html(str);
			},
	...
	<div class="tpl-page-container tpl-page-header-fixed">
		...
		<div class="tpl-content-wrapper">
			...
			<ol class="am-breadcrumb">
				...
				<li><a href="/REIMBURSEMENT/page/basical_people.jsp">个人基本信息</a></li>
				...
				<div class="tpl-block ">
					...
					<div class="am-g tpl-amazeui-form">
						...
						<div class="am-u-sm-12 am-u-md-9">
							<form class="am-form am-form-horizontal" onsubmit="return check()"
								action="/REIMBURSEMENT/PersonUpdateServlet2" method="post">
								<div class="am-text-center" style="color: red">带黄色圆圈项为必填项</div>
								<br>
								
								<div class="am-form-group">
									<label for="user-weibo" class="am-u-sm-3 am-form-label">个人编号</label>
									<div class="am-u-sm-9">
										<input id="user-weibo" placeholder="输入个人编号"
											value="${requestScope.p.personID }" type="text"
											readonly="readonly" name="personID">
									</div>
								</div>
								
								<div class="am-form-group">
									<label for="user-phone" class="am-u-sm-3 am-form-label">证件类型</label>
									<div class="am-u-sm-9">
										<select data-am-selected="{searchBox: 1, maxHeight: 100}"
											name="type" style="display: none;">
											<c:if test="${requestScope.p.certifiType == '身份证' }">
									    	...
									    	<c:if test="${requestScope.p.certifiType == '港澳通行证' }">
									    	...
									    	<c:if test="${requestScope.p.certifiType == '护照' }">
								...
								<div class="am-form-group am-form-warning am-form-icon am-form-feedback">
									<label for="user-weibo" class="am-u-sm-3 am-form-label">证件编号</label>
									<div class="am-u-sm-9">
										<input id="cID" placeholder="输入证件编号" name="cID"
											type="text" value="${requestScope.p.certifiID }">
									</div>
								...
								<div class="am-form-group am-form-warning am-form-icon am-form-feedback">
									<label for="user-weibo" class="am-u-sm-3 am-form-label">姓名</label>
									<div class="am-u-sm-9">
										<input id="name" placeholder="输入姓名" name="name"
											value="${requestScope.p.personName }" type="text">
									</div>
									<span class="am-icon-circle-o"></span>
								</div>
								...
								<div class="am-form-group">
									...
									<div class="am-u-sm-9">
										<select data-am-selected="{searchBox: 1, maxHeight: 100}"
											style="display: none;" name="sex">
											
											<c:if test="${requestScope.p.personSex == '男' }">
											...
											<c:if test="${requestScope.p.personSex == '女' }">
								...
								<div class="am-form-group am-form-warning am-form-icon am-form-feedback">
									<label for="user-weibo" class="am-u-sm-3 am-form-label">出生日期</label>
									<div class="am-u-sm-9">
										<input class="" data-am-datepicker="" readonly=""
											value="${requestScope.p.birthday }" required=""
											placeholder="点击选择日期" type="text" name="birthday">
									</div>
									<span class="am-icon-circle-o"></span>
								</div>
								...
								<div class="am-form-group">
									...
									<input type="hidden" id="curpat" value="${requestScope.p.patID }">
									<div class="am-u-sm-9">
										<select id="pat"
											data-am-selected="{searchBox: 1, maxHeight: 100}"
											style="display: none;" name="patID">
								...
								<div class="am-form-group">
										<label for="user-phone" class="am-u-sm-3 am-form-label">单位名称</label>
										<input type="hidden" id="curinsID" value="${requestScope.p.insID }">

										<div class="am-u-sm-9">
											<select id="InsID" name="InsID"
												data-am-selected="{searchBox: 1, maxHeight: 120}"
												style="display: none;">
									...
									<div class="am-form-group">
										<label for="user-phone" class="am-u-sm-3 am-form-label">定点医疗机构名称</label>
										<input type="hidden" id="curcompID" value="${requestScope.p.compID }">
