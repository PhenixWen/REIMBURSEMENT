		...
		function mediName() {
    		$.ajax({
				...
				success:function(data){
					var curmediId = $("#curmediId").val();
					var str="";
					$(data).each(function(i,yp){
						if(yp.mediId != curmediId){
							str= str + "<option value=" + yp.mediId + ">" + yp.mediName+ "</option>";
						}
						else{
							str= str + "<option value=" + yp.mediId + " selected='selected'>" + yp.mediName + "</option>";
						}
					});
					$("#mediName").html(str);
				},
        ...
        <div class="tpl-portlet-components">
            <div class="portlet-title">
                <div class="caption font-green bold">
                    <span class="am-icon-code"></span>修改处方明细
                </div>
            ...
            <div class="tpl-block ">
                ...
                <div class="am-g tpl-amazeui-form">
                    ...
                    <div class="am-text-center" style="color: red">带黄色圆圈项为必填项</div>
                       <form style="padding-left:100px;" action="/REIMBURSEMENT/edi_cf2?ide=${requestScope.lis.ide}" method="post" class="am-form am-form-horizontal">
                            ...
                            <div class="am-form-group">
                                ...
                                <input type="hidden" id="curmediId" value="${requestScope.lis.mediId}">
                                <div class="am-u-sm-9">
