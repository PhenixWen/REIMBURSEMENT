...
<html class="js cssanimations"><head>
    ...
    <script>
	    function check(id){
			...
			if(p == true)
			$.ajax({
				url:"/REIMBURSEMENT/PersonDeleteServlet?no="+id,
				type:"GET",
				dataType:"text",
				success:function(data){
					if(data == "no"){
						...
						alert("删除成功");
						location.href="/REIMBURSEMENT/page/basical_people.jsp"; 
					}
				},
				error:function(){
					alert("error");
...
<div class="tpl-page-container tpl-page-header-fixed">
    ...
    <div class="tpl-content-wrapper">
        ...
        <ol class="am-breadcrumb">
            ...
            <li><a href="#">公共业务</a></li>
            <li class="am-active">个人基本信息</li>
        </ol>
        <div class="tpl-portlet-components">
            <div class="portlet-title">
                <div class="caption font-green bold">
                    <span class="am-icon-code"></span>个人基本信息
                </div>
            ...
            <div class="tpl-block">
                <div class="am-u-md-12 am-u-sm-centered">
                    <form class="am-form am-form-inline" action="/REIMBURSEMENT/PersonQueryServlet" method="post">
                        <label for="doc-ipt-3" class="am-form-label">个人编号: </label>
                        <div class="am-form-group">
                            <input class="am-form-field" placeholder="编号" name="pid" type="text">
                        </div>
                        <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                        <label for="doc-ipt-3" class="am-form-label">个人姓名:</label>
                        <div class="am-form-group">
                            <input class="am-form-field" placeholder="姓名" name="pname" type="text">
                        </div>
                        <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                        ...
                        <button type="button" class="am-btn am-btn-default am-btn-success" onclick="window.open('/REIMBURSEMENT/page/person_add.jsp')">
                        ...
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                ...
                                <tr>
                                    ...
                                    <th class="table-author am-hide-sm-only">个人编号</th>
                                    <th class="table-title">姓名</th>
                                    <th class="table-type">性别</th>
                                    <th class="table-author am-hide-sm-only">出生日期</th>
                                    <th class="table-set">证件号</th>
                                    <th class="table-set">社保号</th>
                                        ...
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <button class="am-btn am-btn-default am-btn-xs am-text-secondary" type="button"
                                                    onclick="window.location.href='/REIMBURSEMENT/PersonUpdateServlet1?no=${p.personID }'">
                                    <span class="am-icon-pencil-square-o"></span>
                                                	详情或编辑</button>
                                                <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" type="button"
                                                     onclick="check(${p.personID })">
                                    ...
                                    <ul class="am-pagination tpl-pagination">
                                        <c:forEach begin="1" step="1" end="${requestScope.pages}" var="i">
										    ...
										    <c:if test="${i eq requestScope.curpage }">
										    	<li class="am-active">
										    	<a href="/REIMBURSEMENT/PersonQueryServlet?page=${i }">${i }</a>
										    	</li>
										    </c:if>
