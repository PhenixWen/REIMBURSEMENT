  		...
  		function CompName() {
    		$.ajax({
				...
				success:function(data){
					var curcompId = $("#curcompId").val();
					var str="";
					$(data).each(function(i,jg){
						if(jg.compId != curcompId){
							str= str+ "<option value="+ jg.compId+">"+jg.compName+"</option>";							
						}
						else{
							str = str + "<option value=" + jg.compId + " selected='selected'>" + jg.compName + "</option>";
						}
		...
		function solveId() {
  		...
  		function diseName() {
    		$.ajax({
				...
				dataType:"json",
				success:function(data){
					var curdiseId = $("#curdiseId").val();
					var str="";
					$(data).each(function(i,bz){
						if(bz.diseId != curdiseId){
							str= str+ "<option value="+ bz.diseId+">"+bz.diseName+"</option>";							
						}
						else{
							str = str + "<option value=" + bz.diseId + " selected='selected'>" + bz.diseName + "</option>"; 
						}
					});
					$("#diseName").html(str);
				},
            ...
            <div class="tpl-block ">
                ...
                <div class="am-g tpl-amazeui-form">
                    <div class="am-u-sm-12 am-u-md-9">
                        <form action="/REIMBURSEMENT/edi_jz2" method="post" class="am-form am-form-horizontal">
                        	<div class="am-form-group">
                                <label for="user-name" class="am-u-sm-3 am-form-label" for = "personId">人员编号</label>
                                <div class="am-u-sm-9">
                                    <input type="text" name = "personId" id="personId" readonly="readonly" value="${requestScope.personId}">
                                </div>
                            </div>
                        	<div class="am-form-group">
                                <label for="user-name" class="am-u-sm-3 am-form-label">人员姓名</label>
                                <div class="am-u-sm-9">
                                    <input type="text" name = "personName" id="personName" readonly="readonly" value="${requestScope.personName}">
                                </div>
                            </div>
                            <div class="am-form-group am-form-warning am-form-icon am-form-feedback" id="divIns">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" name = "solveId" id="solveId" readonly="readonly" value="${requestScope.solveId}">
                                </div>
                            </div>
                            <div class="am-form-group">
...
<select id="compName" data-am-selected="{searchBox: 1, maxHeight: 100}" style="display: none;" name="compId"></select>
                            ...
                            <div class="am-form-group">
                                ...
                                <input type="hidden" id="curcompId" value="${requestScope.jiuzhen.compId}">
                                <div class="am-u-sm-9">
...
<select id="diseName" data-am-selected="{searchBox: 1, maxHeight: 100}" style="display: none;" name="diseId"></select>
                            ...
                            <div class="am-form-group">
                                ...
                                <input type="hidden" id="curdiseId" value="${requestScope.jiuzhen.diseId}">
                                <div class="am-u-sm-9">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input name = "inDate" type="date" id="user-weibo", value="${requestScope.jiuzhen.inDate}">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label for="user-weibo" class="am-u-sm-3 am-form-label">出院日期</label>
                                <div class="am-u-sm-9">
                                    <input name = "outDate" type="date" id="user-weibo", value="${requestScope.jiuzhen.outDate}">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label for="user-weibo" class="am-u-sm-3 am-form-label">出院原因</label>
                                <div class="am-u-sm-9">
                                    <input name = "outReason" type="text" id="user-weibo", value="${requestScope.jiuzhen.outReason}">
                                </div>
                            </div>
                            <div class="am-form-group">
