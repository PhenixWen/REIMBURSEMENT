...
<div class="tpl-page-container tpl-page-header-fixed">
    ...
    <div class="tpl-content-wrapper">
        ...
        <ol class="am-breadcrumb">
            ...
            <li class="am-active">定点医疗机构信息更改</li>
        </ol>
        ...
        <div class="tpl-portlet-components">
            <div class="portlet-title">
                <div class="caption font-green bold">
                    <span class="am-icon-code"></span>定点医疗机构信息更改
                </div>
            ...
            <div class="tpl-block ">
                ...
                <div class="am-g tpl-amazeui-form">
					...
					<input type = "hidden" id = "hosrank"  value = "${requestScope.company.hosRank }">
					
                    <div class="am-u-sm-12 am-u-md-9">
                    <div class="am-text-center" style="color: red">带黄色圆圈项为必填项</div>
						<br>
                        <form class="am-form am-form-horizontal" action = "/REIMBURSEMENT/JiGouUpdate2Servlet" method = "post" onsubmit = "return check()">
                            <div class="am-form-group">
                                <label for="user-name" class="am-u-sm-3 am-form-label">定点医疗机构编号</label>
                                <div class="am-u-sm-9">
                                    <input type="text" id="user-name" placeholder="输入机构编号" name = "compId" value = "${requestScope.company.compId }" readonly="readonly">

                                </div>
                            </div>

                            <div class="am-form-group am-form-warning am-form-icon am-form-feedback" id = "divComp">
                                <label for="user-email" class="am-u-sm-3 am-form-label">定点医疗机构名称</label>
                                <div class="am-u-sm-9">
                                    <input type="text" id="compName" placeholder="输入机构名称" name = "compName" value = "${requestScope.company.compName }">
...
<!--                                         <option value="社区医院">社区医院</option> -->
                            ...
                            <div class="am-form-group">
                                <label for="user-phone" class="am-u-sm-3 am-form-label">医疗机构类别</label>

                                <div class="am-u-sm-9">
                                    <select data-am-selected="{searchBox: 1, maxHeight: 100}" style="display: none;" name = "kind">
                                        <c:if test="${requestScope.company.kind == '一级' }">
								    		<option value="一级" selected="selected">一级</option>
								    	</c:if>
								        <c:if test="${requestScope.company.kind != '一级' }">
								    		<option value="一级">一级</option>
								    	</c:if>
								    	<c:if test="${requestScope.company.kind == '二级' }">
								    		<option value="二级" selected="selected">二级</option>
								    	</c:if>
								        <c:if test="${requestScope.company.kind != '二级' }">
								    		<option value="二级">二级</option>
								    	</c:if>
								    	<c:if test="${requestScope.company.kind == '三级' }">
                            ...
                            <div class="am-form-group">
                                <label for="user-weibo" class="am-u-sm-3 am-form-label">联系人姓名</label>
                                <div class="am-u-sm-9">
                                    <input type="text" id="user-weibo" placeholder="输入联系人姓名" name = "nam" value = "${requestScope.company.nam }">
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" id="user-weibo" placeholder="输入联系人电话" name = "tel" value = "${requestScope.company.tel }">
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" id="user-weibo" placeholder="备注" name = "remarks" value = "${requestScope.company.remarks }">
                                </div>
                            </div>
                            <div class="am-form-group">
