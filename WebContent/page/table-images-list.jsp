        ...
        <div class="tpl-left-nav tpl-left-nav-hover">
            ...
            <div class="tpl-left-nav-list">
                <ul class="tpl-left-nav-menu">
                    <li class="tpl-left-nav-item">
                        <a href="/REIMBURSEMENT/page/index.jsp" class="nav-link">
            ...
            <a href="/REIMBURSEMENT/page/jigousp.jsp">
                ...
                <i></i>
                                ...
                                <!-- 打开状态 a 标签添加 active 即可   -->
                                <a href="/REIMBURSEMENT/page/table-images-list.jsp" class="active">
                                    <i class="am-icon-angle-right"></i>
                                    <span>图片表格</span>
                                ...
                                <div class="tpl-table-images-content">
                                    ...
                                    <a href="javascript:;" class="tpl-table-images-content-i">
                                        <div class="tpl-table-images-content-i-info">
                                            <span class="ico">
                                    <img src="/REIMBURSEMENT/page/assets/img/user02.png" alt="">追逐

                                 </span>

                                        </div>
                                        <span class="tpl-table-images-content-i-shadow"></span>
                                        <img src="/REIMBURSEMENT/page/assets/img/a1.png" alt="">
                                    </a>
