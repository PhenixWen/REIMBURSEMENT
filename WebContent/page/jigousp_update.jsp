			...
			$(data).each(
					function(i, p) {
						...
						if(cur == p.compName){
							...
							str = str + "<option value=" + p.compName + " selected='selected'>"
							+ p.compName + "</option>";
						}
						else{
							str = str + "<option value=" + p.compName + ">"
							+ p.compName + "</option>";
						}
			...
			<div class="tpl-portlet-components">
				<div class="portlet-title">
					<div class="caption font-green bold">
						<span class="am-icon-code"></span>修改人员就诊机构审批
					</div>
					...
					<div class="am-g tpl-amazeui-form">
						<div class="am-u-sm-12 am-u-md-9">
							...
							<form class="am-form am-form-horizontal"
								...
								action="/REIMBURSEMENT/JiGouSpUpdateServlet2" method="post">
								<div class="am-form-group">
									...
									<%-- <div
										class="am-form-group am-form-warning am-form-icon am-form-feedback"
										id="divComp">
										<label for="user-weibo" class="am-u-sm-3 am-form-label">定点医疗机构编码</label>
										<div class="am-u-sm-9">
											<input id="compID" class="" placeholder="输入定点医疗机构编码"
												value="${requestScope.p.compID }" name="compID" type="text">
										</div>
