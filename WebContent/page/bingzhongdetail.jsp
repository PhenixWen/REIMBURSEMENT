    ...
    <div class="tpl-content-wrapper">
        ...
        <div class="tpl-portlet-components">
            ...
            <table style="  text-align:center;  table-layout:fixed; background-color:white" class="am-table  am-table-striped am-table-hover am-table-compact am-table-bordered am-table-radius am-table-striped">
                <tbody>
                <tr>
                    <td style="color: black">病种编号</td>
                    <td style="color: black">${requestScope.disease.diseId }</td>
                </tr>
                <tr>
                    <td style="color: black">病种名称</td>
                    <td style="color: black">${requestScope.disease.diseName }</td>
                </tr>
                <tr>
                    <td style="color: black">病种类别</td>
                    <td style="color: black">${requestScope.disease.diseKind }</td>
                </tr>
                <tr>
                    <td style="color: black">病种报销标志</td>
                    <td style="color: black">${requestScope.disease.diseM }</td>
                </tr>
                <tr>
                    <td style="color: black">备注</td>
                    <td style="color: black">${requestScope.disease.remarks }</td>
                </tr>
                </tbody>
            </table>
