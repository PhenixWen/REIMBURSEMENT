...
<div class="tpl-page-container tpl-page-header-fixed">
    ...
    <div class="tpl-content-wrapper">
        ...
        <ol class="am-breadcrumb">
            ...
            <li class="am-active">诊疗项目信息详情</li>
        </ol>
        ...
        <div class="tpl-portlet-components">
            ...
            <table style="  text-align:center;  table-layout:fixed; background-color:white" class="am-table  am-table-striped am-table-hover am-table-compact am-table-bordered am-table-radius am-table-striped">
                <tbody>
                <tr>
                    <td style="color: black">诊疗项目编码</td>
                    <td style="color: black">${requestScope.project.projId }</td>
                </tr>
                <tr>
                    <td style="color: black">诊疗项目名称</td>
                    <td style="color: black">${requestScope.project.projName }</td>
                </tr>
                <tr>
                    <td style="color: black">收费类别</td>
                    <td style="color: black">${requestScope.project.feeKind }</td>
                </tr>
                <tr>
                    <td style="color: black">收费项目等级</td>
                    <td style="color: black">${requestScope.project.chargeRank }</td>
                </tr>
                <tr>
                    <td style="color: black">单位</td>
                    <td style="color: black">${requestScope.project.company }</td>
                </tr>
                <tr>
                    <td style="color: black">生产厂家</td>
                    <td style="color: black">${requestScope.project.manufacturer }</td>
                </tr>
                <tr>
                    <td style="color: black">限制使用范围</td>
                    <td style="color: black">${requestScope.project.rge }</td>
                </tr>
                <tr>
                    <td style="color: black">医院等级</td>
                    <td style="color: black">${requestScope.project.hosRank }</td>
                </tr>
                <tr>
                    <td style="color: black">备注</td>
                    <td style="color: black">${requestScope.project.remarks }</td>
                </tr>
                </tbody>
            </table>
