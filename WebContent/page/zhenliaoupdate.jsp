...
// 					alert(str);
		...
		$(function(){
			$("#projName").blur(function(){
				var value = $("#projName").val();
				if(value != ''){
					$("#divComp")
						.attr("class",
		...
		function check() {
			...
			if (!$("#divComp").hasClass("am-form-error")) {
				return true;
			} else {
				alert("请按要求填写");
				return false;
...
<div class="tpl-page-container tpl-page-header-fixed">
    ...
    <div class="tpl-content-wrapper">
        ...
        <ol class="am-breadcrumb">
            ...
            <li><a href="/REIMBURSEMENT/page/zhenliaoquery.jsp">诊疗项目信息</a></li>
            <li class="am-active">诊疗项目信息更改</li>
        </ol>
        ...
        <div class="tpl-portlet-components">
            <div class="portlet-title">
                <div class="caption font-green bold">
                    <span class="am-icon-code"></span>诊疗项目信息更改
                </div>
            ...
            <div class="tpl-block ">
                ...
                <div class="am-g tpl-amazeui-form">
					<input type = "hidden" id = "hosrank"  value = "${requestScope.project.hosRank }">
					<input type = "hidden" id = "feekind"  value = "${requestScope.project.feeKind }">
                    <div class="am-u-sm-12 am-u-md-9">
                    	<div class="am-text-center" style="color: red">带黄色圆圈项为必填项</div>
						<br>
                        <form class="am-form am-form-horizontal" action = "/REIMBURSEMENT/ZhenLiaoUpdate2Servlet" method = "post" onsubmit = "return check()">
                            <div class="am-form-group">
                                <label for="user-name" class="am-u-sm-3 am-form-label">诊疗项目编号</label>
                                <div class="am-u-sm-9">
                                    <input type="text" id="user-name" placeholder="输入项目编号" name = "projId" value = "${requestScope.project.projId }" readonly="readonly">

                                </div>
                            </div>

                            <div class="am-form-group am-form-warning am-form-icon am-form-feedback" id = "divComp">
                                <label for="user-email" class="am-u-sm-3 am-form-label">诊疗项目名称</label>
                                <div class="am-u-sm-9">
                                    <input type="text" id="projName" placeholder="输入项目名称" name = "projName" value = "${requestScope.project.projName }">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <select data-am-selected="{searchBox: 1, maxHeight: 100}" style="display: none;" name = "chargeRank" value = "${requestScope.medicine.chargeRank }">
                                        <c:if test="${requestScope.project.chargeRank == '一级' }">
								    		<option value="一级" selected="selected">一级</option>
								    	</c:if>
								        <c:if test="${requestScope.project.chargeRank != '一级' }">
								    		<option value="一级">一级</option>
								    	</c:if>
								    	<c:if test="${requestScope.project.chargeRank == '二级' }">
								    		<option value="二级" selected="selected">二级</option>
								    	</c:if>
								        <c:if test="${requestScope.project.chargeRank != '二级' }">
								    		<option value="二级">二级</option>
								    	</c:if>
								    	<c:if test="${requestScope.project.chargeRank == '三级' }">
                            ...
                            <div class="am-form-group">
                                <label for="user-weibo" class="am-u-sm-3 am-form-label">单位</label>
                                <div class="am-u-sm-9">
                                    <input type="text" id="user-weibo" placeholder="输入单位名称" name = "company" value = "${requestScope.project.company }">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label for="user-weibo" class="am-u-sm-3 am-form-label">生产厂家</label>
                                <div class="am-u-sm-9">
                                    <input type="text" id="user-weibo" placeholder="输入生产厂家" name = "manufacturer" value = "${requestScope.project.manufacturer }">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label for="user-weibo" class="am-u-sm-3 am-form-label">限定使用范围</label>
                                <div class="am-u-sm-9">
                                    <input type="text" id="user-weibo" placeholder="输入使用范围" name = "rge" value = "${requestScope.project.rge }">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label for="user-weibo" class="am-u-sm-3 am-form-label">备注</label>
                                <div class="am-u-sm-9">
                                    <input type="text" id="user-weibo" placeholder="备注" name = "remarks" value = "${requestScope.project.remarks }">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <div class="am-u-sm-9 am-u-sm-push-3">
                                    <button type="sumbit" class="am-btn am-btn-primary">更改</button>
                                </div>
                            </div>
                        </form>
                    </div>
